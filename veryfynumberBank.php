...
if($userRow!=null){
	...
	unset($_SESSION["bank_otp"]);
  $_SESSION["bank_mobile"] = $mobile;
...
session_start();
@$otp=$_POST['otp'];
$mobile= $_SESSION["bank_mobile"];
$sessionotp=$_SESSION["bank_otp"];

if(strlen($sessionotp!==$otp))  
{
	echo"0";}else{
		
$_SESSION["bank_mobilematched"] = $_SESSION["bank_mobile"];
unset($_SESSION["bank_mobile"]);
unset($_SESSION["bank_otp"]);
