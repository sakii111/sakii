...
//========final Result===================================================
if($switchstatus=='yes' && $switchtab=='parity' && isset($manualnumber))
{
...
if (strpos($tempColor, "++") !== false) {
    // substring "++" is present in the string
	$colors = explode("++", $tempColor);
	$clo = $colors[0];
	$res1 = $colors[1];
}
else if (strpos($tempColor, "+") !== false) {
    // substring "++" is present in the string
	$colors = explode("+", $tempColor);
	$clo = $colors[0];
	$res1 = $colors[1];
...
$ResultQueryA= mysqli_query($con,"INSERT INTO `betrec`(`period`, `ans`, `num`, `clo`, `res1`, `time`) VALUES ('".$periodid."','".$tempNumber."','".$randomPrice."','".$clo."','".$res1."','".$today."')");
...
if (strpos($newcolor, "++") !== false) {
    // substring "++" is present in the string
	$colors = explode("++", $newcolor);
	$clo = $colors[0];
	$res1 = $colors[1];
} 
else if (strpos($newcolor, "+") !== false) {
    // substring "+" is present in the string
	$colors = explode("+", $newcolor);
	$clo = $colors[0];
	$res1 = $colors[1];
...
//=================random data end====================================
$ResultQueryA= mysqli_query($con,"INSERT INTO `betrec`(`period`, `ans`, `num`, `clo`, `res1`, `time`) VALUES ('".$periodid."','".$randomNumber."','".$randomPrice."','".$clo."','".$res1."','".$today."')");
