...
<body class="uni-body pages-main"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
    <uni-app class="uni-app--maxwidth">
        <uni-page data-page="pages/main">
            <!---->
            <!---->
            <uni-page-wrapper>
                <uni-page-body>
                    <uni-view data-v-5d7012ef="">
                        <!---->
                        <!---->
                        <!---->
                        <!---->
                        <uni-view data-v-3ff3c467="" data-v-5d7012ef="">
                            <uni-view data-v-3ff3c467="" class="my-header-height"></uni-view>
                            <uni-view data-v-3ff3c467="" class="padding-xl">
                                <uni-view data-v-3ff3c467=""
                                    class=" my-textsize-balance padding-xl radius shadow bg-blue margin-top">
                                    <uni-view data-v-3ff3c467="" class="user-info-box">
                                        <uni-view data-v-3ff3c467="" class="portrait-box" style="width: 20%;">
                                            <uni-image data-v-3ff3c467="" class="head-img">
                                                <div
                                                    style="background-image: url(&quot;./me_files/headimg.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                </div><img src="./me_files/headimg.png" draggable="true">
                                                <!---->
                                            </uni-image>
                                        </uni-view>
                                        <uni-view data-v-3ff3c467=""
                                            style="width: 50%; text-align: left; margin-left: -10px;">
                                            <uni-view data-v-3ff3c467="" class="info-box" style="margin-top: 4px;">
                                                <uni-text data-v-3ff3c467="" class="username"><span>User: <?php echo $row['nickname']?></span>
                                                </uni-text>
                                            </uni-view>
                                            <uni-view data-v-3ff3c467="" class="info-box" style="margin-top: 8px;">
                                                <uni-text data-v-3ff3c467="" class="username"><span>ID:<?php echo  $_SESSION['usercode']?></span>
                                                </uni-text>
                                            </uni-view>
                                        </uni-view>
                                        <!---->
                                    </uni-view>
                                    <uni-view data-v-3ff3c467="" class="margin-top">
                                        <uni-text data-v-3ff3c467=""><span>Mobile: +91<?php echo  $_SESSION['username']?></span></uni-text>
                                    </uni-view>
                                    <uni-view data-v-3ff3c467="" class="margin-top">
                                        <uni-text data-v-3ff3c467=""><span>Available balance: ₹<span id = "balancetop">0.00</span></span></uni-text>
                                    </uni-view>
                                    <uni-button data-v-3ff3c467=""
                                        class="my-textsize cu-btn bg-green shadow margin-top" onclick="window.location.href='/recharge#';">Recharge</uni-button>
                                    <uni-button data-v-3ff3c467=""
                                        class="my-textsize cu-btn bg-white shadow margin-left" onclick="mud()">Change Nick Name
                                    </uni-button>
                                    <uni-button data-v-3ff3c467=""
                                        class="btn-notice cu-btn cuIcon bg-white round margin-left"
                                        data-target="menuModal" onclick="shown()">
                                        <uni-text data-v-3ff3c467="" class=" cuIcon-noticefill"><span></span></uni-text>
                                    </uni-button>
                                </uni-view>
                            </uni-view>
                            <uni-view data-v-3ff3c467="" class="content-list">
                                <uni-view data-v-0f3e59c5="" data-v-3ff3c467="">
                                    <uni-view data-v-0f3e59c5="" class="mix-tree-list">
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="window.location.href='bonusrecord'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-form">
                                                <span></span></uni-text>Bonus Record<uni-text data-v-0f3e59c5=""
                                                class="mix-tree-icon3"><span></span></uni-text>
                                        </uni-view>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="window.location.href='invite'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-goods">
                                                <span></span></uni-text>Promotion<uni-text data-v-0f3e59c5=""
                                                class="mix-tree-icon3"><span></span></uni-text>
                                        </uni-view>
                                         
                                        <uni-view data-v-0f3e59c5=""  class="mix-tree-item border show itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="show(wallet1,1)">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-pay"><span></span>
                                            </uni-text>Wallet<uni-text data-v-0f3e59c5="" id="1"
                                                class="mix-tree-icon3 cuIcon-unfold"><span></span></uni-text>
                                        </uni-view>
                                        <div id="wallet1" style="display:none;">
                                        <uni-view data-v-0f3e59c5=""  class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;" onclick="window.location.href='recharge'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Recharge<uni-text data-v-0f3e59c5="" class="mix-tree-icon3"><span></span>
                                            </uni-text>
                                        </uni-view>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;" onclick="window.location.href='withdraw'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Withdrawal<uni-text data-v-0f3e59c5="" class="mix-tree-icon3"><span></span>
                                            </uni-text>
                                        </uni-view>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;"onclick="window.location.href='trans'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Transactions<uni-text data-v-0f3e59c5="" class="mix-tree-icon3">
                                                <span></span></uni-text>
                                        </uni-view>
                                        </div>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="window.location.href='fee'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-vipcard">
                                                <span></span></uni-text>Bank Card<uni-text data-v-0f3e59c5=""
                                                class="mix-tree-icon3"><span></span></uni-text>
                                        </uni-view>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="window.location.href='address'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-addressbook">
                                                <span></span></uni-text>Address<uni-text data-v-0f3e59c5=""
                                                class="mix-tree-icon3"><span></span></uni-text>
                                        </uni-view>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show itemIcon" onclick="show(sec,2)"
                                            style="padding-left: 0px; z-index: 50;">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-safe">
                                                <span></span></uni-text>Account Security<uni-text data-v-0f3e59c5="" id="2"
                                                class="mix-tree-icon3 cuIcon-unfold" ><span></span></uni-text>
                                        </uni-view>
                                        <div id="sec" style="display:none;">
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;" onclick="window.location.href='reset'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Reset Password<uni-text data-v-0f3e59c5="" class="mix-tree-icon3">
                                                <span></span></uni-text>
                                        </uni-view></div>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="show(app,3)">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-down">
                                                <span></span></uni-text>App Download<uni-text data-v-0f3e59c5="" id="3"
                                                class="mix-tree-icon3 cuIcon-unfold"><span></span></uni-text>
                                        </uni-view>
                                        <div id="app" style="display:none;">
                                             <a style="color:black;text-decoration:none " target="_self" href="/malinimall.apk"
                    download="malinimall.apk" >
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Android Download<uni-text data-v-0f3e59c5="" class="mix-tree-icon3">
                                                <span></span></uni-text>
                                        </uni-view></a></div>
                                     
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show itemIcon"
                                            style="padding-left: 0px; z-index: 50;" onclick="show(about,4)" >
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2 cuIcon-question">
                                                <span></span></uni-text>About<uni-text data-v-0f3e59c5="" id="4"
                                                class="mix-tree-icon3 cuIcon-unfold"><span></span></uni-text>
                                        </uni-view>
                                        <div id="about" style="display:none;">
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;" onclick="window.location.href='privacylog'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Privacy Policy<uni-text data-v-0f3e59c5="" class="mix-tree-icon3">
                                                <span></span></uni-text>
                                        </uni-view>
                                        <uni-view data-v-0f3e59c5="" class="mix-tree-item border show last"
                                            style="padding-left: 15px; z-index: 49;" onclick="window.location.href='risk'">
                                            <uni-text data-v-0f3e59c5="" class="mix-tree-icon2"><span></span></uni-text>
                                            Risk Disclosure Agreement<uni-text data-v-0f3e59c5=""
                                                class="mix-tree-icon3"><span></span></uni-text>
                                        </uni-view></div>
                                    </uni-view>
                                </uni-view>
                            </uni-view>
                            <uni-button data-v-3ff3c467="" class="btn-logout bg-grey margin-tb-sm lg" onclick="log()">Logout
                            </uni-button>
                                    ...
                                    <uni-view data-v-3ff3c467="" class="text-left">
                                        <uni-view data-v-3ff3c467="" class="cu-bar bg-white justify-end">
                                            <uni-view data-v-3ff3c467="" class="content"
                                                style="font-weight: bold; font-size: 1.5em;">notice</uni-view>
                                        </uni-view>
                                        <uni-view data-v-3ff3c467="">
                                            <uni-text data-v-3ff3c467="" class="notice-content padding-xl block"
                                                style="font-size: 1.2em;"><span><?php echo  $notice?></span>
                                            </uni-text>
                                        </uni-view>
                                        <uni-view data-v-3ff3c467="" class="cu-bar bg-white justify-end">
                                            <uni-view data-v-3ff3c467="" class="action">
                                                <uni-button data-v-3ff3c467="" class="cu-btn text-blue" onclick="hide()">CLOSE
                                                </uni-button>
                                            </uni-view>
                                        </uni-view>
                                    </uni-view>
                            ...
                            <uni-view data-v-3ff3c467="" id=nickname class="cu-modal">
                                <uni-view data-v-3ff3c467="" class="cu-dialog">
                                    <uni-view data-v-3ff3c467="" class="cu-bar bg-white justify-end">
                                        <uni-view data-v-3ff3c467="" class="content" style="font-weight: bold;">Change
                                            Nick Name</uni-view>
                                    </uni-view>
                                    <uni-view data-v-3ff3c467="" class="padding-xl bg-white"
                                        style="font-size: 8px; text-align: left;">
                                        <uni-text data-v-3ff3c467="" class="nickname-text"><span>Nick Name</span>
                                        </uni-text>
                                        <uni-view data-v-3ff3c467="" class="cu-form-group padding block">
                                            <uni-view data-v-3ff3c467="" class="mobile lg padding block"></uni-view>
                                            <uni-input data-v-3ff3c467="" data-key="nickname">
                                                <div class="uni-input-wrapper">
                                                    <form action="" method="post" id="nick">
                                                    <div class="uni-input-placeholder input-placeholder"
                                                        data-v-3ff3c467="" data-v-5d7012ef="" style=""></div>
                                                    <input maxlength="20" placeholder="Nick Name" step="" name="nick" enterkeyhint="done" autocomplete="off"
                                                        type="text" class="uni-input-input">
                                                    <!---->
                                                </div></form>
                                            </uni-input>
                                        </uni-view>
                                        <uni-view data-v-3ff3c467="" class="my-line-height block bg-gray"></uni-view>
                                    </uni-view>
                                    <uni-view data-v-3ff3c467="" class="cu-bar bg-white justify-end">
                                        <uni-view data-v-3ff3c467="" class="action">
                                            <uni-button data-v-3ff3c467="" class="cu-btn text-gray border" onclick="cancel()">CANCEL
                                            </uni-button>
                                            <uni-button data-v-3ff3c467="" class="cu-btn text-blue border margin-left" onclick="frm()">
                                                CONFRIM</uni-button>
                                        </uni-view>
                                    </uni-view>
                                </uni-view>
                        ...
                        <uni-view data-v-5d7012ef="" class="cu-bar tabbar bg-white shadow foot">
                            <uni-view data-v-5d7012ef="" data-cur="basics" class="action" onclick="window.location.href='indexlogin'">
                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                    <uni-image data-v-5d7012ef="">
                                        <div
                                            style="background-image: url(&quot;./me_files/basics.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./me_files/basics.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-5d7012ef="" class="text-gray">Home</uni-view>
                            </uni-view>
                            <uni-view data-v-5d7012ef="" data-cur="component" class="action"onclick="window.location.href='searchlogin'">
                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                    <uni-image data-v-5d7012ef="">
                                        <div
                                            style="background-image: url(&quot;./me_files/component.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./me_files/component.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-5d7012ef="" class="text-gray">Search</uni-view>
                            </uni-view>
                            <uni-view data-v-5d7012ef="" data-cur="plugin" class="action"onclick="window.location.href='win'">
                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                    <uni-image data-v-5d7012ef="">
                                        <div
                                            style="background-image: url(&quot;./me_files/plugin.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./me_files/plugin.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-5d7012ef="" class="text-gray">Win</uni-view>
                            </uni-view>
                            <uni-view data-v-5d7012ef="" data-cur="personcenter" class="action">
                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                    <uni-image data-v-5d7012ef="">
                                        <div
                                            style="background-image: url(&quot;./me_files/personcenter_cur.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./me_files/personcenter_cur.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-5d7012ef="" class="text-blue">My</uni-view>
                            </uni-view>
                        </uni-view>
                    </uni-view>
                </uni-page-body>
