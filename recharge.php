...
$sqlr = "SELECT  min_r FROM notice WHERE id='1'";
...
?>
<!DOCTYPE html>
<!-- saved from url=(0044)https://lulumalls.co/#/pages/person/recharge -->
<html lang="zh-CN"
...
<head>
  ...
  <link rel="stylesheet" href="./recharge_files/index.e18c94d4.css">
 ...
 */
  ...
  <style type="text/css">
    .menu[data-v-239cf1c0] {
      position: absolute;
      right: 10px
        /* top:20upx; */
    }

    .title[data-v-239cf1c0] {
      position: relative
    }

    .btn-recharge[data-v-239cf1c0] {
      width: 209px;
      height: 52px
        /* position: relative; */
  ...
  <style type="text/css">
    ...
    .padding-xl[data-v-ea172e90] {
      padding: 10px
    }

    .my-text[data-v-ea172e90] {
      position: absolute;
      /*相对父节点 绝对位置*/
      right: 26px;
      top: 94px
    ...
    .my-lottery-info[data-v-ea172e90] {
      position: absolute;
      right: 15px
    }

    .my-space-x[data-v-ea172e90] {
      margin-right: 10px
    }
  </style>
  <style type="text/css">
...
<body class="uni-body pages-person-recharge"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
  <uni-app class="uni-app--maxwidth">
    <uni-page data-page="pages/person/recharge">
      <!---->
      <!---->
      <uni-page-wrapper>
        <uni-page-body>
          <uni-view data-v-239cf1c0="">
            <uni-view data-v-3a572a86="" data-v-239cf1c0="">
              <uni-view data-v-3a572a86="" class="cu-custom" style="height: 52px;">
                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue" style="height: 52px; padding-top: 0px;">
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='/me#';">
                    <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>Recharge
                  </uni-view>
                  <!---->
                  <uni-view data-v-3a572a86="" class="content" style="top: 0px;"></uni-view>
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='/rechargerecord#';">
                    <uni-text data-v-3a572a86="" class="cuIcon-sort"><span></span></uni-text>
                  </uni-view>
                  <!---->
                  <!---->
                </uni-view>
            ...
            <uni-view data-v-239cf1c0="" class="solids-bottom padding-xs flex align-center">
              <uni-view data-v-239cf1c0="" class="flex-sub text-center">
                <uni-view data-v-239cf1c0="" class="solid-bottom text-xl padding">
                  <uni-text data-v-239cf1c0="" class="text-black text-bold"><span>Balance:₹ <span id="balancetop">0.00</span></span></uni-text>
                </uni-view>
              </uni-view>
            </uni-view>
            <uni-view data-v-239cf1c0="" class="cu-form-group padding-xl"
              style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
              <uni-text data-v-239cf1c0="" class="password lg cuIcon-pay block"><span></span></uni-text>
              <uni-input data-v-239cf1c0="" data-key="rechargemoney">
                <div class="uni-input-wrapper">
                  <div class="uni-input-placeholder input-placeholder" data-v-239cf1c0=""></div><input id="amount" maxlength="20" value="<?php echo  $mini ?>" placeholder="Enter or Select recharge amount" step="0.000000000000000001" enterkeyhint="done" autocomplete="off"
                    type="number" class="uni-input-input">
                  <!---->
                </div>
              </uni-input>
            </uni-view>
            <uni-view data-v-239cf1c0="" class="grid margin-bottom text-center">
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="100" data-money="100"><?php echo  $mini?></uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="300" data-money="300">300</uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="500" data-money="500">500</uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="1000" data-money="1000">1000</uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="2000" data-money="2000">2000</uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="5000" data-money="5000">5000</uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="10000" data-money="10000">10000</uni-button>
              <uni-button data-v-239cf1c0="" class="my-btn-num" id="50000" data-money="50000">50000</uni-button>
            </uni-view>
            <uni-view data-v-239cf1c0="" class="cu-form-group">Tips:Please contact customer care if you have any
              questions about the order or payment failure</uni-view>
            <uni-checkbox-group data-v-239cf1c0="" class="block">
              <uni-view data-v-239cf1c0="" class="cu-form-group" onclick="p1()" style="display:none;" >
                <uni-checkbox data-v-239cf1c0="" data-num="0" id="check1" class="round blue checked">
                  <div class="uni-checkbox-wrapper">
                    <div class="uni-checkbox-input" style="color: rgb(0, 122, 255);"></div>
                  </div>
                </uni-checkbox>
                <uni-view data-v-239cf1c0="" class="title">SEPROPAY_UPI(200-50000)</uni-view>
              </uni-view>
              <uni-view data-v-239cf1c0="" class="cu-form-group" onclick="p2()" >
                <uni-checkbox data-v-239cf1c0="" data-num="1" id="check2" class="round blue">
                  <div class="uni-checkbox-wrapper">
                    <div class="uni-checkbox-input" style="color: rgb(0, 122, 255);"></div>
                  </div>
                </uni-checkbox>
                <uni-view data-v-239cf1c0="" class="title">quickpay(100-50000)</uni-view>
              </uni-view>
             
            
            </uni-checkbox-group>
            <div id="copied">Minimum Recharge ₹<?php echo  $mini?></div>
            <uni-button data-v-239cf1c0="" class="glb_btn_color btn-recharge padding-xs bg-blue margin-tb-sm" onclick="pr()">
              <uni-text data-v-239cf1c0="" class="text-white"><span>Recharge</span></uni-text>
            </uni-button>
            <uni-view data-v-239cf1c0="" class="cu-tabbar-height"></uni-view>
            <uni-view data-v-239cf1c0="" class="cu-modal"id="sub" style="z-index: 0;">
              <uni-view data-v-239cf1c0="" class="cu-dialog bg-white">
                <uni-view data-v-239cf1c0="" class="cu-bar  bg-blue">
                  <uni-view data-v-239cf1c0="" class="glb_btn_color"
                    style="margin-left: 20px; text-align: left; font-weight: bold;" id="pay">SEPROPAY_UPI(200-50000)</uni-view>
                </uni-view>
                <uni-button data-v-239cf1c0="" class="cu-btn text-blue" onclick="fill()" >AUTO FILL</uni-button>
                <uni-view data-v-239cf1c0="" class="input-content" style="text-align: left;">
                  <uni-view data-v-239cf1c0="" class="cu-form-group"
                    style="border: 1px solid whitesmoke; border-radius: 0px;">
                    <uni-text data-v-239cf1c0="" class="cuIcon-myfill" style="margin-right: 10px;"><span></span>
                    </uni-text>
                    <uni-input data-v-239cf1c0="" data-key="actualName">
                      <div class="uni-input-wrapper">
                        <div class="uni-input-placeholder input-placeholder" data-v-239cf1c0=""></div><input
                          maxlength="40" step="" enterkeyhint="done" placeholder="Actual Name" id="name" autocomplete="off" type="text"
                  ...
                  <uni-view data-v-239cf1c0="" class="cu-form-group"
                    style="border: 1px solid whitesmoke; border-radius: 0px;">
                    <uni-text data-v-239cf1c0="" class="cuIcon-mobilefill" style="margin-right: 10px;"><span></span>
                    </uni-text>
                    <uni-input data-v-239cf1c0="" data-key="mobile">
                      <div class="uni-input-wrapper">
                        <div class="uni-input-placeholder input-placeholder" data-v-239cf1c0=""></div>
                        <input maxlength="20" step="" enterkeyhint="done" autocomplete="off" id="phone" placeholder="Mobile Number" type="text"
                          class="uni-input-input">
                        <!---->
                      </div>
                    </uni-input>
                  ...
                  <uni-view data-v-239cf1c0="" class="cu-form-group"
                    style="border: 1px solid whitesmoke; border-radius: 0px;">
                    <uni-text data-v-239cf1c0="" class="cuIcon-mail" style="margin-right: 10px;"><span></span>
                    </uni-text>
                    <uni-input data-v-239cf1c0="" data-key="email">
                      <div class="uni-input-wrapper">
                        <div class="uni-input-placeholder input-placeholder" data-v-239cf1c0=""></div><input
                          maxlength="40" step="" enterkeyhint="done" placeholder="Email" id="mail" autocomplete="off" type="text"
                          class="uni-input-input">
                        <!---->
                      </div>
                    </uni-input>
                ...
                <uni-view data-v-239cf1c0="" class="cu-bar justify-end">
                  <uni-view data-v-239cf1c0="" class="action">
                   <uni-button data-v-239cf1c0="" class="cu-btn text-gray border" onclick="closex()" >CANCLE</uni-button>
                    <uni-button data-v-239cf1c0="" class="cu-btn text-blue border margin-left" onclick="submit()" >CONTINUE</uni-button>
                  </uni-view>
                </uni-view>
              </uni-view>
            </uni-view>
    ...
    <uni-modal style="display: none;">
      ...
      <div class="uni-modal">
        ...
        <div class="uni-modal__bd">The balance is not enough</div>
  ...
  <script>
    ...
    var fivehundred = document.getElementById("100");
   var thousand = document.getElementById("300");
   var twothousand = document.getElementById("500");
   var fivethousand = document.getElementById("1000");
   var tenthousand = document.getElementById("2000");
   var twentythousand = document.getElementById("5000");
   var ythousand = document.getElementById("10000");
   var fiftythousand = document.getElementById("50000");

   fivehundred.onclick = function(){
       document.getElementById("amount").value="<?php echo  $mini?>";
   }
   ...
   twentythousand.onclick = function(){
    ...
    ythousand.onclick = function(){
       document.getElementById("amount").value="10000";
   }
    fiftythousand.onclick = function(){
       document.getElementById("amount").value="50000";
   }
   
    function p1(){
   document.getElementById("check1").className="round blue checked";
   
   document.getElementById("check2").className="round blue";
   
   window.payment=1;
   }
    function p2(){
   document.getElementById("check1").className="round blue";
  
   document.getElementById("check2").className="round blue checked";
   ...
   function closex(){
     console.log("close");
      document.getElementById("sub").className="cu-modal";
   }
   function pr(){
    if(window.payment==1){
       if( document.getElementById("amount").value><?php echo  ($mini-1)?>){
        document.getElementById("sub").className="cu-modal show";
        document.getElementById("pay").innerHTML="SEPROPAY_UPI(200-50000)";
       }
       else{ 
       ...
       else if(window.payment==2){
            if( document.getElementById("amount").value><?php echo  ($mini-1)?>){
              document.getElementById("sub").className="cu-modal show";
              document.getElementById("pay").innerHTML="quickpay(100-50000)";
       }
       else{ 
           var x = document.getElementById("copied");
  ...
  e=document.getElementById("mail");
   ...
   function fill(){
     n.value="<?php echo  $name?>";
     m.value="<?php echo  $_SESSION['username']?>";
     e.value="<?php echo  $mail?>";

   }
   function submit(){ 
     
    if(n.value.length>0 && m.value.length>0 && e.value.length>0){
     
        if(window.payment==1){
       if( document.getElementById("amount").value><?php echo  ($mini-1)?>){
        var link="/PayU/index?am="
