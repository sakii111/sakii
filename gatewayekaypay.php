...
if(isset($_POST['submitRecharge'])){
  ...
  $sqlinsert =  mysqli_query($con,"INSERT INTO `tbl_recharge` (userid, amount,status,createdate,mobile,txn,paymentMethod ) VALUES ('$userid','$amount','$status','$createdate','$mobile','$utr_id','$paymentMethod')" );
...
<span id="order_time" style="">05:00</span>
</div>
...
<a class="btn-copy" data-clipboard-text="Payhere887@kotak" style="text-align: center;width: 60px;font-size:16px">copy</a>
</div>
<div class="upi-payment-step">
<span style="min-width: 52px;font-weight: 800;color:#333">STEP 1:</span>
<!--<a href="upi://pay?pa=kumar786@bandhan&amp;cu=INR&amp;pn=SACHIN%20KUMAR%20MITTAL&amp;am=500&amp;tn=C320211213121903638354&amp;tr=C320211213121903638354" target="_blank">
...
<input type="text" id="upi-input" value="" name="channel_order" placeholder="ENTER REF NO.:1347xxxxxxxx" maxlength="12" oninput="this.value=this.value.replace(/[^\d]/g,'')" onchange="this.value=this.value.replace(/[^\d]/g,'')">
</div>
