...
?>
<!DOCTYPE html>
<!-- saved from url=(0067)https://lulumalls.co/#/pages/person/addBank?title=Add%20Bank%20Card -->
<html lang="zh-CN"
...
<head>
  ...
  <link rel="stylesheet" href="./bankcard_files/index.e18c94d4.css">
  <style type="text/css">
    @charset "UTF-8";
...
<body class="uni-body pages-person-addBank"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
  <uni-app class="uni-app--maxwidth">
    <uni-page data-page="pages/person/addBank">
      <!---->
      <!---->
      <uni-page-wrapper>
        <uni-page-body>
          <uni-view data-v-7e55c319="">
            <uni-view data-v-3a572a86="" data-v-7e55c319="">
              <uni-view data-v-3a572a86="" class="cu-custom" style="height: 52px;">
                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue" style="height: 52px; padding-top: 0px;">
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='fee'">
                    <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>
                    <uni-text data-v-7e55c319="" class="text-white"><span>Add Bank Card</span></uni-text>
                  </uni-view>
                  <!---->
            ...
            <uni-scroll-view data-v-7e55c319="" class="nav text-center text-gray"
              style="margin-bottom: 5px; top: 100px;">
              <div class="uni-scroll-view">
                <div class="uni-scroll-view" style="overflow: auto hidden;">
                  <div class="uni-scroll-view-content">
                    <!---->
                    <uni-view data-v-7e55c319="" data-id="0" class="cu-item text-white cur">Select Bank Card</uni-view>

                  </div>
                </div>
              </div>
            </uni-scroll-view>
            <form action="" id="bankcard" method="post">
            <uni-view data-v-7e55c319="" class="input-content">
              <uni-view data-v-7e55c319="" class="cu-form-group"
                style="border: 1px solid whitesmoke; border-radius: 0px;">
                <uni-input data-v-7e55c319="" data-key="actualName">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-7e55c319=""></div><input maxlength="40"
                      step="" enterkeyhint="done" name="name" placeholder="Actual Name" autocomplete="off" type="text"
              ...
              <uni-view data-v-7e55c319="" class="cu-form-group"
                style="border: 1px solid whitesmoke; border-radius: 0px;">
                <uni-input data-v-7e55c319="" data-key="ifscCode">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-7e55c319=""></div><input maxlength="20"
                      step="" enterkeyhint="done" placeholder="IFSC Code"  name="ifsc" autocomplete="off" type="text"
                      class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
              ...
              <uni-view data-v-7e55c319="" class="cu-form-group"
                style="border: 1px solid whitesmoke; border-radius: 0px;">
                <uni-input data-v-7e55c319="" data-key="bankName">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-7e55c319=""></div><input maxlength="20"
                      step="" enterkeyhint="done" autocomplete="off"  placeholder="Bank Name" type="text"
                      class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
              ...
              <uni-view data-v-7e55c319="" class="cu-form-group"
                style="border: 1px solid whitesmoke; border-radius: 0px;">
                <uni-input data-v-7e55c319="" data-key="upiAccount">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-7e55c319=""></div><input maxlength="40"
                      step="" enterkeyhint="done" autocomplete="off" name="account" placeholder="Bank Account" type="text"
                      class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
              ...
              <uni-view data-v-7e55c319="" class="cu-form-group"
                style="border: 1px solid whitesmoke; border-radius: 0px;">
                <uni-input data-v-7e55c319="" data-key="mobile">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-7e55c319=""></div><input maxlength="20"
                      step="" enterkeyhint="done" value="<?php echo  $_SESSION['username']?>" placeholder="Mobile Number" autocomplete="off" type="text"
                      class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
              ...
              <uni-view data-v-7e55c319="" class="cu-form-group"
                style="border: 1px solid whitesmoke; border-radius: 0px;">
                <uni-input data-v-7e55c319="" data-key="email">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-7e55c319=""></div><input maxlength="40"
                      step="" enterkeyhint="done" name="email" placeholder="Email" autocomplete="off" type="text"
                      class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
              </uni-view>
              <uni-button data-v-7e55c319="" class="glb_btn_color btn-Continue margin-tb-sm lg"  onclick="submit()">
                <uni-text data-v-7e55c319="" class="text-white"><span>Continue</span></uni-text>
              </uni-button>
              <!---->
            </uni-view>
          </form>
