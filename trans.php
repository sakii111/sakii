...
$query1 = "SELECT * FROM `record` WHERE username='".$_SESSION['username']."' AND staus='success' ";
...
$query = "SELECT * FROM `record` WHERE username='".$_SESSION['username']."' AND staus='success' ORDER BY id DESC" ;  
...
while ($row2 = mysqli_fetch_array($result)) { 
    ...
    $dataRow = $dataRow."
    <uni-view data-v-ea172e90='' class='flex padding-xl solid-top'>
    <uni-button data-v-ea172e90='' class='cu-btn cuIcon round my-space-x bg-$colour'
      style='margin-top: 2px;'>
      <uni-text data-v-ea172e90='' class='cuIcon-pay text-white'><span></span></uni-text>
    </uni-button>
    <uni-view data-v-ea172e90='' class='margin-tb-sm'>Withdraw <span style='color:red';>-$row2[2]</span> </uni-view>
    <uni-view data-v-ea172e90='' class='text-gray' style='position: absolute; right: 26px; top: 20px;'>
    $row2[4]</uni-view>
  </uni-view>
...
$query1 = "SELECT * FROM `recharge` WHERE username='".$_SESSION['username']."' AND status='successfull' ";
...
//retrieve the selected results from database   
$query0 = "SELECT * FROM `recharge` WHERE username='".$_SESSION['username']."' AND status='successfull'  ORDER BY id DESC" ;  
$result0 = mysqli_query($conn, $query0);  
  
//display the retrieved result on the webpage  
while ($row20 = mysqli_fetch_array($result0)) { 
   
    if($row20[3]==wait){
      $colour="yellow";   
    }elseif($row20[3]==failed){
         $colour="red";
    }else{
        $colour="green";
    }
    ...
    <uni-view data-v-ea172e90='' class='margin-tb-sm'>Recharge <span style='color:green';>+$row20[2]</span></uni-view>
    <uni-view data-v-ea172e90='' class='text-gray' style='position: absolute; right: 26px; top: 20px;'>
    $row20[4]</uni-view>
  </uni-view>
...
<!DOCTYPE html>
<!-- saved from url=(0050)https://lulumalls.co/#/pages/person/rechargeRecord -->
<html lang="zh-CN"
...
<head>
  ...
  <link rel="stylesheet" href="./rechargerecord_files/index.e18c94d4.css">
...
<body class="uni-body pages-person-rechargeRecord"><noscript><strong>Please enable JavaScript to
      continue.</strong></noscript>
  <uni-app class="uni-app--maxwidth">
    <uni-page data-page="pages/person/rechargeRecord">
      <!---->
      <!---->
      <uni-page-wrapper>
        <uni-page-body>
          <uni-view data-v-ea172e90="">
            <uni-view data-v-3a572a86="" data-v-ea172e90="">
              <uni-view data-v-3a572a86="" class="cu-custom" style="height: 52px;">
                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue" style="height: 52px; padding-top: 0px;">
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='me#'">
                    <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>Transaction Record
                  </uni-view>
                  <!---->
            ...
            <uni-view data-v-ea172e90="" class="my-record-view bg-white shadow">
              <uni-view data-v-ea172e90="">
                <uni-view data-v-ea172e90="" class="">
              ...
              <uni-view data-v-ea172e90="" class="padding bg-white my-textsize solid-top" style="height: 52px;">
                <uni-view data-v-ea172e90="" class="my-lottery-info">
                  <uni-text data-v-ea172e90="" class="my-space-x"><span>1-10 of 1</span></uni-text>
                  <uni-button data-v-ea172e90="" class="cu-btn cuIcon  sm round my-space-x" data-type="down">
                    <uni-text data-v-ea172e90="" class="cuIcon-back"><span></span></uni-text>
                  </uni-button>
                  <uni-button data-v-ea172e90="" class="cu-btn cuIcon sm round" data-type="up">
                    <uni-text data-v-ea172e90="" class="cuIcon-right"><span></span></uni-text>
                  </uni-button>
                </uni-view>
              </uni-view>
            </uni-view>
            <uni-view data-v-ea172e90="" class="cu-tabbar-height"></uni-view>
          </uni-view>
        </uni-page-body>
      </uni-page-wrapper>
    </uni-page>
