...
//Later Shonu
$sql4= mysqli_query($con,"INSERT INTO `tbl_transaction`(`userid`,`amount`,`transtype`,`obalance`,`nbalance`,`createdate`) VALUES ('".$userid."','".$paidamount."','Win A Prize','".$walletResult['amount']."','".$finalbalancecredit."','".$crtdt."')");
}
}
}
?>
