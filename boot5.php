...
$conn->query($addwin2);
$addplayclube2="UPDATE vipbetting SET res='success' WHERE ans='lion'  AND username=$winner2 AND period=$period  ";
...
$addwin2="UPDATE users SET balance= balance+$winamount2 WHERE username=$winner2";
$conn->query($addwin2);
$addplayclube2="UPDATE vipbetting SET res='success' WHERE ans='elephant'  AND username=$winner2 AND period=$period  ";
$conn->query($addplayclube2);
...
$addwin2="UPDATE users SET balance= balance+$winamount2 WHERE username=$winner2";
$conn->query($addwin2);
$addplayclube2="UPDATE vipbetting SET res='success' WHERE ans='king'  AND username=$winner2 AND period=$period  ";
$conn->query($addplayclube2);
...
$addwin2="UPDATE users SET balance= balance+$winamount2 WHERE username=$winner2";
$conn->query($addwin2);
$addplayclube2="UPDATE vipbetting SET res='success' WHERE ans='cow'  AND username=$winner2 AND period=$period  ";
$conn->query($addplayclube2);
