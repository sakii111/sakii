...
<?php
	...
	$user=mysqli_query($con,"select * from `tbl_withdraw` where `userid`='".$userid."' ORDER BY ID DESC");
		...
		<div data-v-5ac41059="" class="recharge">
			<nav data-v-5ac41059="" class="top_nav">
				<div data-v-5ac41059="" class="left">
					...
					<span data-v-5ac41059="">Withdrawal Record</span>
				</div>
			</nav>
			<div data-v-5ac41059="" class="recharge_box">
				...
				?>
							...
							<?php 
								...
								$finalamount = $userArray['finalamount'];
							...
							?>
										<tr data-v-5ac41059="" id="interdata">
											<td data-v-5ac41059="">
												...
												<div id="interpara"><span><?php echo $serial; ?></span><span>BankCard</span></div>
