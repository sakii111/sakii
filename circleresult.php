...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $dataRow = $dataRow."<tr class='user' ><td></td><td >$row2[1]</td><td >$row2[2]</td><td>$row2[3]</td><td >$row2[4]</td><td >$row2[6]</td><td >$row2[7]</td><td >$row2[8]</td></tr>";
}
...
">Jhon Doe</h6>
 ...
 <input id="searchbar" onkeyup="search()" type="text"
        ...
        <h2 style="font-size:20px;padding:5px; color:grey; text-align:center;">Circle User's Record</h2>
<div>
