                        ...
                        <uni-view data-v-91f724d0="" data-v-5d7012ef="">
                            ...
                            <uni-view data-v-91f724d0="" class="padding-xl">
                                <uni-view data-v-91f724d0=""
                                    ...
                                    <uni-view data-v-91f724d0="" class="margin-top">
                                        <uni-text data-v-91f724d0=""><span>Available balance: ₹<span id="emredbalancetop">0.00</span></span></uni-text>
                                    </uni-view>
                                        ...
                                        <div class="uni-scroll-view-content">
                                            ...
                                            <uni-view data-v-91f724d0="" class="flex text-center">
                                                ...
                                                <uni-view data-v-91f724d0="" data-id="1"
                                                    class="cu-item flex-sub my-textsize" onclick="window.location.href='win1'">Sapre</uni-view>
                                                <uni-view data-v-91f724d0="" data-id="2"
                                                    class="cu-item flex-sub my-textsize text-blue cur" onclick="window.location.href='win2'">Bcone</uni-view>
                            ...
                            <uni-view data-v-91f724d0="" class="flex padding justify-between">
                                <uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-green shadow"
                                    data-color="green" id="emredgreen"  onclick="green()">Join Green</uni-button>
                                <uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-purple shadow"
                                    data-color="violet" id="emredvoilet" onclick="vio()">Join Violet</uni-button>
                                <uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-red shadow"
                                    data-color="red"  id="emredredbutton" onclick="red()">Join Red</uni-button>
                            </uni-view>
                            <uni-view data-v-91f724d0="" class="grid margin-bottom text-center padding-xl">
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="0" id="emrednum0" onclick="emrednum0()"
                                    style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(229, 77, 66) 50%);">
                                    0</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="1" id="emrednum1" onclick="emrednum1()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    1</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="2" id="emrednum2" onclick="emrednum2()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    2</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="3" id="emrednum3" onclick="emrednum3()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    3</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="4" id="emrednum4" onclick="emrednum4()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    4</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="5" id="emrednum5" onclick="emrednum5()"
                                    style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(57, 181, 74) 50%);">
                                    5</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="6" id="emrednum6" onclick="emrednum6()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    6</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="7" id="emrednum7" onclick="emrednum7()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    7</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="8" id="emrednum8" onclick="emrednum8()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    8</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="9" id="emrednum9" onclick="emrednum9()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    9</uni-button>
                            </uni-view>
                           
                            <div id="emredansrec"> </div>
