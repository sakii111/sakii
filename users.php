...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $dataRow = $dataRow."<tr class='user' ><td></td><td>$row2[5]</td><td >$row2[1]</td><td>$row2[3]</td><td>$row2[4]</td><td >$row2[16]</td><td>$row2[2]</td><td> ₹$balace0 </td><td><a href='/report.php?user=$row2[1]'>Information</a></td></tr>";
}
