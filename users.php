...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $dataRow = $dataRow."<tr class='user' ><td></td><td >$row2[1]</td><td >$row2[15]</td><td >$row2[16]</td><td>$row2[2]</td><td> ₹$balace0 </td><td>$row2[12]</td><td>$row2[7]</td><td>$row2[8]</td><td>$row2[13]</td></tr>";
}
