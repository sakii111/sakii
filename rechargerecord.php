...
<?php
	...
	$user=mysqli_query($con,"select * from `deposits_new` where `userid`='".$userid."' ORDER BY ID DESC");
		...
		<div data-v-5ac41059="" class="recharge">
			<nav data-v-5ac41059="" class="top_nav">
				<div data-v-5ac41059="" class="left">
					...
					<span data-v-5ac41059="">Recharge Record</span>
				</div>
			</nav>
			<div data-v-5ac41059="" class="recharge_box">
				...
				?>
							...
							<?php 
								...
								$amount = $userArray['amount'];
								$serial = $userArray['serial'];
								$source = $userArray['source'];
							...
							?>
										<tr data-v-5ac41059="" id="interdata">
											<td data-v-5ac41059="">
												<div id="interpara"><span>₹ <?php echo $amount; ?></span><span style="color:<?php if($status==2){echo "#009688";}else{echo "#FFA82E";} ?>;"> <?php if($status==2){echo "Success";}else{echo "Unpaid";} ?></span></div>
												<div id="interpara"><span><?php if($source=="ekpay"){echo "REK";}else{echo "RWE";} ?><?php echo $serial; ?></span><span><?php if($source=="ekpay"){echo "EKPay";}else{echo "wepay";} ?></span></div>
