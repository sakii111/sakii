...
$role=mysqli_fetch_array($query);
 ...
 ?> 
  ...
  <li><a class="list_sec btn btn-primary" href="manage_admin_upi.php">ADMIN Bank</a></li>
...
<div class="col-sm-6">
 ...
 <input type="submit" class="btn btn-primary" value="done"  name="submit" disabled ></div>
