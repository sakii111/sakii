...
$child=mysqli_query($con,"Select * from `child_menu` where `p_id`='".$parent_array['id']."' And `status`='1'");
	while($child_array=mysqli_fetch_array($child)){ ?>
	 ...
	 ?>
       ...
       <li> <a href="manage_user.php"><i class="fa fa-circle-o"></i>Users</a></li>
       <li> <a href="manage_winresult.php"><i class="fa fa-circle-o"></i>Manual Result</a></li>
       <li> <a href="manage_tradehistory.php"><i class="fa fa-circle-o"></i>Trade Records</a></li>
       <li> <a href="reward_system.php"><i class="fa fa-circle-o"></i>Reward System</a></li>
       <li> <a href="manage_transaction.php"><i class="fa fa-circle-o"></i>Users Bid History</a></li>
       <li> <a href="user_result.php"><i class="fa fa-circle-o"></i>Users Result</a></li>
       <li> <a href="recharge_history.php"><i class="fa fa-circle-o"></i>Recharge History</a></li>
           <li> <a href="depositupdate.php"><i class="fa fa-circle-o"></i>Deposit History</a></li>
    <li>&nbsp;</li>
     <li>&nbsp;</li>
    </ul>
