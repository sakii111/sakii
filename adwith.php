...
$query =  "SELECT  * FROM record WHERE status='Applying' ORDER BY id DESC ";
...
{
    $alink='"/waccept.php?am='.$row2[2].'&un='.$row2[1].'&id='.$row2[0].'"';
    $dlink='"/wdecline.php?am='.$row2[2].'&un='.$row2[1].'&id='.$row2[0].'"';
    $dataRow = $dataRow."<tr><td>$row2[1]</td><td>$row2[2]</td><td onclick='window.location.href=$alink;' style='background:green;'>YES</td><td onclick='window.location.href=$dlink;'style='background:red;'>NO</td></tr>";
}
