...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $image='"https://playclube.in/payment/'.$row2[6].'.jpeg"';
    $dataRow = $dataRow."<tr> <td>$row2[0]</td><td>$row2[4]</td><td>$row2[1]</td><td>$row2[5]</td><td>$row2[6]</td><td onclick='window.location.href=$image;' style='background:green;'><img src=$image style='height: 50px' ></td><td>$row2[2]</td><td onclick='window.location.href=$alink;' style='background:green;'>Approve</td><td onclick='window.location.href=$dlink;'style='background:red;'>Reject</td></tr>";
}
