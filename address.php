...
<html lang="en" style="font-size: 104.5px;">
	...
	<body style="font-size: 12px;">
		...
		<div data-v-2ff24370="" class="recharge">
			<nav data-v-2ff24370="" class="top_nav">
				<div data-v-2ff24370="" class="left">
					<img data-v-2ff24370="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAByUlEQVRoQ+3ZwSsFURTH8e
					...
					<span data-v-2ff24370="">Address</span>
				</div>
				<div data-v-2ff24370="" class="right">
					<img data-v-2ff24370="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAABnElEQVRoQ+2aMU4DMRBF/+
					...
					B2SH79q0RSsE17Kf+F46d9UzqZahUpHajnT4l4hPoe/wbmcuQzOS0vzQAAAABJRU5ErkJggg==" alt="" onclick="window.location.href='addaddress.php';">
				</div>
			</nav>
			<div data-v-2ff24370="" class="address_list">
				<ul data-v-2ff24370="" class="list_ul"></ul><!---->
			</div>
			<!-- footer -->
		</div>
