...
<head>
        ...
        <link rel="stylesheet" href="./indexlogin_files/index.e18c94d4.css">
        <script async="" src="./indexlogin_files/api.js.download"></script>
        <style type="text/css">
                @charset "UTF-8";
 ...
 */
        ...
        <style type="text/css">
                ...
                .my-btn-num[data-v-91f724d0] {
                        ...
                        /* background-image :url('/ic_notify.png'); */
                        margin-bottom: 10px
                }
        ...
        <script charset="utf-8" src="./indexlogin_files/pages-main.18ff6f50.js.download"></script>
        <style type="text/css">
...
<body class="uni-body pages-main"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
        <uni-app class="uni-app--maxwidth">
                <uni-page data-page="pages/main">
                        ...
                        <uni-page-wrapper>
                                <uni-page-body>
                                        <uni-view data-v-5d7012ef="">
                                                <!---->
                                                <uni-view data-v-1f700c9a="" data-v-5d7012ef="">
                                                        <uni-view data-v-1f700c9a="">
                                                                <uni-view data-v-3a572a86="" data-v-1f700c9a="">
                                                                        <uni-view data-v-3a572a86="" class="cu-custom"
                                                                                style="height: 52px;">
                                                                                <uni-view data-v-3a572a86=""
                                                                                        class="cu-bar fixed bg-grey"
                                                                                        style="height: 52px; padding-top: 0px;">
                                                                                        <!---->
                                                                                        <uni-view data-v-3a572a86=""
                                                                                                class="action">
                                                                                                <uni-image
                                                                                                        ...
                                                                                                        style="height: 46px;">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./ic_notify2.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./indexlogin_files/ic_notify2.png"
                                                                                                                draggable="true">
                                                                                                        <uni-resize-sensor>
                                                                                                                <div>
                                                                                                                        <div>
                    ...
                    download="malinimall.apk" >
                                                        ...
                                                        <uni-view data-v-1f700c9a="" class="content"
                                                                style="height: 62px; padding-top: 0px;">
                                                                <uni-view data-v-1f700c9a="" class="text-area"
                                                                        style="margin-top: 5px;">
                                                                        <uni-text data-v-1f700c9a="" class="title">
                                                                                <span>Welcome Back </span></uni-text>
                                                                </uni-view>
                                                                <uni-view data-v-1f700c9a="" class="text-area"
                                                                        style="margin-top: 5px;">
                                                                        <uni-text data-v-1f700c9a="" class="title2">
                                                                                <span>Quality Guarantee</span>
                                                                        </uni-text>
                                                                </uni-view>
                                                        </uni-view>
                                                        <uni-swiper data-v-1f700c9a="" class="screen-swiper">
                                                                                ...
                                                                                <div class="uni-swiper-slide-frame"
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./indexlogin_files/logo0.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./indexlogin_files/logo0.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./indexlogin_files/logo1.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./indexlogin_files/logo1.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./indexlogin_files/logo2.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./indexlogin_files/logo2.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./indexlogin_files/logo3.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./indexlogin_files/logo3.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                        ...
                                                        <uni-view data-v-1f700c9a="" class="nav-list">
                                                                <uni-view data-v-1f700c9a="" data-id="0"
                                                                        class="nav-li padding-xl radius shadow bg-white"
                                                                        style="animation: 1.2s ease 0s 1 normal none running show;">
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/item0.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/item0.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                                        </uni-view>
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-name">Yellow Chimes A5
                                                                                Grade American Crystal Traditional Gold
                                                                                Plated Without Piercing Combo Nose Pins
                                                                                for Women &amp; Girls</uni-view>
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-money">₹ 1754.00
                                                                        </uni-view>
                                                                        <uni-text data-v-1f700c9a=""
                                                                                class="cuIcon-undefined"><span></span>
                                                                        </uni-text>
                                                                </uni-view>
                                                                <uni-view data-v-1f700c9a="" data-id="1"
                                                                        class="nav-li padding-xl radius shadow bg-white"
                                                                        style="animation: 1.4s ease 0s 1 normal none running show;">
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/item1.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/item1.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                                        ...
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-name">PC Jeweller The
                                                                                Quizmu 18KT Yellow Gold and Diamond Nose
                                                                                Pin for Women</uni-view>
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-money">₹ 19888.00
                                                                        </uni-view>
                                                                        <uni-text data-v-1f700c9a=""
                                                                                class="cuIcon-undefined"><span></span>
                                                                        </uni-text>
                                                                </uni-view>
                                                                <uni-view data-v-1f700c9a="" data-id="2"
                                                                        class="nav-li padding-xl radius shadow bg-white"
                                                                        style="animation: 1.6s ease 0s 1 normal none running show;">
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/item2.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/item2.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                                        ...
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-name">PC Jeweller The
                                                                                Fallamhain 18KT Yellow Gold and Diamond
                                                                                Nose Pin for Women</uni-view>
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-money">₹ 15666.00
                                                                        </uni-view>
                                                                        <uni-text data-v-1f700c9a=""
                                                                                class="cuIcon-undefined"><span></span>
                                                                        </uni-text>
                                                                </uni-view>
                                                                <uni-view data-v-1f700c9a="" data-id="3"
                                                                        class="nav-li padding-xl radius shadow bg-white"
                                                                        style="animation: 1.8s ease 0s 1 normal none running show;">
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/item3.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/item3.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                                        ...
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-name">PC Jeweller The
                                                                                Cormack 18KT Yellow Gold and Diamond
                                                                                Nose Pin for Women</uni-view>
                                                                        <uni-view data-v-1f700c9a=""
                                                                                class="product-money">₹ 7500.00
                                                                        </uni-view>
                                                                        <uni-text data-v-1f700c9a=""
                                                                                class="cuIcon-undefined"><span></span>
                                                                        </uni-text>
                                                        ...
                                                        <uni-view data-v-1f700c9a="" class="cu-tabbar-height">
                                                        </uni-view>
                                                </uni-view>
                                                <!---->
                                                <!---->
                                                ...
                                                <uni-view data-v-5d7012ef="" class="cu-bar tabbar bg-white shadow foot">
                                                        <uni-view data-v-5d7012ef="" data-cur="basics" class="action">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/basics_cur.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/basics_cur.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
                                                                <uni-view data-v-5d7012ef="" class="text-blue">Home
                                                                </uni-view>
                                                        </uni-view>
                                                        <uni-view data-v-5d7012ef="" data-cur="component"
                                                                class="action" onclick="window.location.href='searchlogin'">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/component.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/component.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
                                                                <uni-view data-v-5d7012ef="" class="text-gray">Search
                                                                </uni-view>
                                                        </uni-view>
                                                        <uni-view data-v-5d7012ef="" data-cur="plugin" class="action" onclick="window.location.href='win'">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/plugin.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/plugin.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
                                                                <uni-view data-v-5d7012ef="" class="text-gray">Win
                                                                </uni-view>
                                                        </uni-view>
                                                        <uni-view data-v-5d7012ef="" data-cur="personcenter"
                                                                class="action" onclick="window.location.href='me'">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./indexlogin_files/personcenter.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./indexlogin_files/personcenter.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
                                                                <uni-view data-v-5d7012ef="" class="text-gray">My
                                                                </uni-view>
                                                        </uni-view>
                                                </uni-view>
                                        </uni-view>
                        ...
                        <div class="uni-modal">
                                ...
                                <div class="uni-modal__ft">
                                        <div class="uni-modal__btn uni-modal__btn_default" style="color: rgb(0, 0, 0);">
                                                取消 </div>
                                        <div class="uni-modal__btn uni-modal__btn_primary"
                                                style="color: rgb(0, 122, 255);"> 确定 </div>
                                </div>
                        </div>
                        <!---->
                </uni-modal>
        ...
        <script src="./indexlogin_files/chunk-vendors.8dd36274.js.download"></script>
        <script src="./indexlogin_files/index.547e89af.js.download"></script>
        <div
