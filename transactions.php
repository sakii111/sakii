...
<?php
	...
	$user=mysqli_query($con,"select * from `tbl_transaction` where `userid`='".$userid."' ORDER BY ID DESC");
		...
		<div data-v-5ac41059="" class="recharge">
			<nav data-v-5ac41059="" class="top_nav">
				<div data-v-5ac41059="" class="left">
					...
					<span data-v-5ac41059="">Transactions</span>
				</div>
			</nav>
				...
				?>
							...
							?>
										<tr data-v-5ac41059="" id="interdata">
											<td data-v-5ac41059="">
												<div id="interpara">
													<span>₹ <?php echo $finalamount; ?></span>
													<span>
														₹ <?php echo $obalance; ?>
													</span>
												</div>
												<div id="interpara">
													<span>
														<?php 
															if($transtype=='LVL1COMM' || $transtype=='LVL2COMM' || $transtype=='LVL3COMM'){
																echo "Rebate";
															}
															else{
																echo $transtype;
													...
													<span>₹ <?php echo $nbalance; ?></span>
												</div>
												<div id="interpara"><?php echo $createdate; ?></div>
											</td>
										</tr>
