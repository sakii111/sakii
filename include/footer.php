...
<div class="appBottomMenu">
  ...
  <div class="item <?php if($urlpage=='search.php'){echo'active';}?>"> <a href="search.php">
   ...
   <?php if(isset($_SESSION['frontuserid'])){?>
    ...
    <div class="item <?php if($urlpage=='login.php' || $urlpage=='signup.php' || $urlpage=='forgot-password.php' || $urlpage=='mine.php' || $urlpage=='recharge.php' || $urlpage=='transactions.php'){echo'active';}?>"> <a href="mine.php" class="icon toggleSidebar">
