...
if(isset($_POST['approve'])){
    ...
    if($wal){
		...
		$succes1 = mysqli_query($con, "UPDATE `deposits_new` SET `status` = '2' WHERE `userid` = '".$uid."' && `amount` = '$deposit'");
...
if(isset($_POST['reject'])){
    ...
    $deposit = $_POST['amount'];
	  ...
	  $reject1 = mysqli_query($con, "UPDATE `deposits_new` SET `status` = '3' WHERE `userid` = '".$uid."' && `amount` = '$deposit'");
