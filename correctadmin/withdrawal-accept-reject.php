                      ...
                      <?php if($Result['status']==0){?>
                        <div class="col-md-6 "> 
							<a href="javascript:void(0);" class="btn btn-success btn-block">
								<strong><i class="fa fa-check"></i> Agreed</strong>
							</a>
						</div>
						<div class="col-md-6 ">
							<a href="javascript:void(0);" class="btn btn-success btn-block" onClick="acceptrejectconfirm(<?php echo $Result['id'];?>,'withdraw');">
								<strong><i class="fa fa-check"></i> Withdrawing</strong>
							</a> 
						</div>
						...
						<?php }else if($Result['status']==1){?>
							<div class="col-md-6 ">
								<a href="javascript:void(0);" class="btn btn-success btn-block" onClick="acceptrejectconfirm(<?php echo $Result['id'];?>,'accept');">
									<strong><i class="fa fa-check"></i> Agree</strong>
								</a> 
							</div>
							<div class="col-md-6 "> 
								<a href="javascript:void(0);" class="btn btn-danger btn-block" onClick="acceptrejectconfirm(<?php echo $Result['id'];?>,'reject');">
