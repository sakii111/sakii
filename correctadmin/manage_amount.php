...
$sql= "UPDATE `tbl_paymentsetting` SET `rechargeamount` = '$mra',`withdrawalamount` = '$mwa',`bonusamount` = '$ib',`rechargebonus` = '$rb',`level1` = '$level1',`level2` = '$level2',`level3` = '$level3' WHERE `id`= '1'";
