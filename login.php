  ...
  <div class="appContent1">
    ...
    <form action="#" id="loginForm" method="post" class="card-body" autocomplete="off">
      ...
      <i style="color:#841DA8;" class="icon ion-md-phone-portrait">&emsp;</i>
        <input type="tel" id="login_mobile" name="login_mobile" class="form-control textbox" placeholder="Mobile Number" onKeyPress="return isNumber(event)" class=

            "form-control textbox" value="" placeholder=

            "Mobile Number" onkeypress="return isNumber(event)" maxlength="10">
      </div>
      <div class="inner-addon left-addon">
      <i style="color:#841DA8;" class="icon ion-md-lock">&emsp;</i>
        <input type="password" id="login_password" name="login_password" class="form-control textbox" value="" placeholder="Password"> 
      </div>
