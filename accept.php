...
$opt="SELECT SUM(recharge) as total FROM `recharge` WHERE username='$username' AND status='successfull'";
...
$addwin00="UPDATE recharge SET status='successfull' WHERE username='$username' AND recharge='$amount' AND utr='$utr'";
$conn->query($addwin00);
