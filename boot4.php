...
$conn->query($addwin2);
$addplayclube2="UPDATE abbetting SET res='success' WHERE ans='A'  AND username=$winner2 AND period=$period  ";
...
$addwin2="UPDATE users SET balance= balance+$winamount2 WHERE username=$winner2";
$conn->query($addwin2);
$addplayclube2="UPDATE abbetting SET res='success' WHERE  ans='B' AND username=$winner2 AND period=$period  ";
$conn->query($addplayclube2);
...
$addwin2="UPDATE users SET balance= balance+$winamount2 WHERE username=$winner2";
$conn->query($addwin2);
$addplayclube2="UPDATE abbetting SET res='success' WHERE  ans='T' AND username=$winner2 AND period=$period  ";
$conn->query($addplayclube2);
