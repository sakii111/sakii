...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  echo "<script>
     document.addEventListener('DOMContentLoaded', function(event) { 
                 ...
                 document.getElementById('snackbar').innerHTML='Please enter username and password';
...
?>
<!DOCTYPE html>
<!-- saved from url=(0044)https://lulumalls.co/#/pages/person/password -->
<html lang="zh-CN"
...
<head>
  ...
  <link rel="stylesheet" href="./reset_files/index.e18c94d4.css">
...
.btn-del{
  ...
  <style type="text/css">
    .btn-login[data-v-b724c938] {
      width: 209px
    }
  </style>
</head>

<body class="uni-body pages-person-password"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
  <uni-app class="uni-app--maxwidth">
    <uni-page data-page="pages/person/password">
      <!---->
      <!---->
      <uni-page-wrapper>
        <uni-page-body>
          <uni-view data-v-b724c938="">
            <uni-view data-v-3a572a86="" data-v-b724c938="">
              <uni-view data-v-3a572a86="" class="cu-custom" style="height: 52px;">
                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue" style="height: 52px; padding-top: 0px;">
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='me'">
                    <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>Reset Password
                  </uni-view>
                  <!---->
            ...
            <uni-view data-v-b724c938="" class="input-content">
              <uni-view data-v-b724c938="" class="cu-form-group"
                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                <uni-view data-v-b724c938="" class="mobile lg cuIcon-mobilefill"></uni-view>
                <uni-input data-v-b724c938="" data-key="mobile">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-b724c938=""></div><input
                      maxlength="13" step="" enterkeyhint="done" autocomplete="off" placeholder="Mobile Numer" name="username" type="text" class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
              </uni-view>
              <uni-view data-v-b724c938="" class="cu-form-group"
                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                <uni-text data-v-b724c938="" class="password lg cuIcon-commentfill"><span></span></uni-text>
                <uni-input data-v-b724c938="" data-key="code">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-placeholder" data-v-b724c938=""></div>
                    <input maxlength="6" step="0.000000000000000001" placeholder="Verification Code" name="otp" enterkeyhint="done" autocomplete="off"
                      type="number" class="uni-input-input">
                    <!---->
                  </div>
                </uni-input>
                <uni-button data-v-b724c938="" class="cu-btn bg-blue shadow" onclick="sendcode()" id="otpbtn">OTP</uni-button>
              </uni-view>
              <uni-view data-v-b724c938="" class="cu-form-group"
                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                <uni-text data-v-b724c938="" class="password lg cuIcon-command"><span></span></uni-text>
                <uni-input data-v-b724c938="" minlength="6" data-key="password">
                  <div class="uni-input-wrapper">
                    <div class="uni-input-placeholder input-empty" data-v-b724c938=""></div><input
                      maxlength="20" step="" enterkeyhint="done" placeholder="New Password" name="newpassword" autocomplete="off" type="password"
            ...
            <uni-button data-v-b724c938="" class="btn-login bg-blue margin-tb-sm lg" onclick="sub()">Continue</uni-button>
          </uni-view>
        </uni-page-body>
      </uni-page-wrapper>
    </uni-page>
