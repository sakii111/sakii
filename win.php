...
?>
<!DOCTYPE html>
<!-- saved from url=(0023)https://lulumalls.co/#/ -->
<html lang="zh-CN"
			...
			<uni-page-wrapper>
				<uni-page-body>
					<uni-view data-v-5d7012ef="">
						...
						<!---->
						<!---->
						<uni-view data-v-91f724d0="" data-v-5d7012ef="">
							<uni-view data-v-91f724d0="" class="my-header-height"></uni-view>
							<uni-view data-v-91f724d0="" class="padding-xl">
								<uni-view data-v-91f724d0=""
									class=" my-textsize-balance padding-xl radius shadow bg-blue margin-top">
									<uni-view data-v-91f724d0="" class="margin-top">
										<uni-text data-v-91f724d0=""><span>Available balance: ₹<span
													id="saprebalancetop">0.00</span></span></uni-text>
									</uni-view>
									<uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-green shadow margin-top"
										onclick="location.href='recharge'">Recharge</uni-button>
									<uni-button data-v-91f724d0=""
										class="my-textsize cu-btn bg-white shadow margin-left" id="readrule">Read Rule
									</uni-button>
									<uni-text data-v-91f724d0="" class="my-text cuIcon-refresh"
										onclick="location.reload()"><span></span></uni-text>
								</uni-view>
							</uni-view>
							<uni-scroll-view data-v-91f724d0="" class="bg-white nav">
								<div class="uni-scroll-view">
									<div class="uni-scroll-view" style="overflow: auto hidden;">
										<div class="uni-scroll-view-content">
											<!---->
											<uni-view data-v-91f724d0="" class="flex text-center">
												<uni-view data-v-91f724d0="" data-id="0"
													class="cu-item flex-sub my-textsize text-blue cur"
													onclick="window.location.href='win'">Parity</uni-view>
												<uni-view data-v-91f724d0="" data-id="1"
													class="cu-item flex-sub my-textsize"
													onclick="window.location.href='win1'">Sapre</uni-view>
												<uni-view data-v-91f724d0="" data-id="2"
													class="cu-item flex-sub my-textsize"
													onclick="window.location.href='win2'">Bcone</uni-view>
												<uni-view data-v-91f724d0="" data-id="3"
													class="cu-item flex-sub my-textsize"
													onclick="window.location.href='win3'">Emerd</uni-view>
											</uni-view>
										</div>
									</div>
								</div>
							...
							<uni-view data-v-91f724d0="" class="padding-xl">
								<uni-text data-v-91f724d0="" class="cuIcon-upstagefill"><span>Period</span></uni-text>
								<uni-text data-v-91f724d0="" class="my-lottery-info"><span>Count Down</span></uni-text>
								<uni-view data-v-91f724d0="" style="padding: 10px 10px 0px;">
									<uni-text data-v-91f724d0="" style="font-size: 1.5em;"><span id="period">
											<?php echo  $sperio?>
										</span>
									</uni-text>
									<uni-text data-v-91f724d0="" class="my-lottery-time"><span id="demo"></span>
									</uni-text>
								</uni-view>
							</uni-view>
							<uni-view data-v-91f724d0="" class="flex padding justify-between">
								<uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-green shadow"
									data-color="green" id="sapregreen" onclick="green()">Join Green</uni-button>
								<uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-purple shadow"
									data-color="violet" id="saprevoilet" onclick="vio()">Join Violet</uni-button>
								<uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-red shadow" data-color="red"
									id="sapreredbutton" onclick="red()">Join Red</uni-button>
							</uni-view>
							<uni-view data-v-91f724d0="" class="grid margin-bottom text-center padding-xl">
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="0" id="saprenum0"
									onclick="saprenum0()"
									style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(229, 77, 66) 50%);">
									0</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="1" id="saprenum1"
									onclick="saprenum1()"
									style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
									1</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="2" id="saprenum2"
									onclick="saprenum2()"
									style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
									2</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="3" id="saprenum3"
									onclick="saprenum3()"
									style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
									3</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="4" id="saprenum4"
									onclick="saprenum4()"
									style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
									4</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="5" id="saprenum5"
									onclick="saprenum5()"
									style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(57, 181, 74) 50%);">
									5</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="6" id="saprenum6"
									onclick="saprenum6()"
									style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
									6</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="7" id="saprenum7"
									onclick="saprenum7()"
									style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
									7</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="8" id="saprenum8"
									onclick="saprenum8()"
									style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
									8</uni-button>
								<uni-button data-v-91f724d0="" class="my-btn-num" data-num="9" id="saprenum9"
									onclick="saprenum9()"
									style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
									9</uni-button>
							</uni-view>
					<div id="sapreansrec"> </div>
							...
							<uni-view data-v-6d17f23c="" data-v-91f724d0="" id="rule" class="cu-modal">
								<uni-view data-v-6d17f23c="" class="cu-dialog">
									<uni-view data-v-6d17f23c="" class="cu-bar bg-white justify-end">
										<uni-view data-v-6d17f23c="" class="content" style="font-weight: bold;">Rule of
											Guess</uni-view>
									</uni-view>
									<uni-view data-v-6d17f23c="" class="padding-xl"
										style="font-size: 8px; text-align: left;">
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">3 minutes 1
											issue, 2 minutes and 30 seconds to order, 30 seconds to show the lottery
											result. It opens all day. The total number of trade is 480 issues</div>
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">If you spend
											100 to trade, after deducting 2 service fee, your contract amount is 98:
										</div>
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">1. JOIN GREEN:
											if the result shows 1,3,7,9, you will get (98*2) 196</div>
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">If the result
											shows 5, you will get (98*1.5) 147</div>
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">2. JOIN RED: if
											the result shows 2,4,6,8, you will get (98*2) 196; If the result shows 0,
											you will get (98*1.5) 147</div>
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">3. JOIN VIOLET:
											if the result shows 0 or 5, you will get (98*4.5) 441</div>
										<div data-v-6d17f23c="" data-v-ecb15022="" style="padding: 8px;">4.SELECT
											NUMBER:if the result is the same as the number you selected, you will
											get(98*9)882</div>
									</uni-view>
									<uni-view data-v-6d17f23c="" class="cu-bar bg-white justify-end">
										<uni-view data-v-6d17f23c="" class="action" id="ruleclose">
											<uni-button data-v-6d17f23c="" class="cu-btn text-blue border">CLOSE
											</uni-button>
										</uni-view>
									</uni-view>
								</uni-view>
							...
							<uni-view data-v-1a01b218="" data-v-91f724d0="" id="sapregreenbox" class="cu-modal">
								<uni-view data-v-1a01b218="" class="cu-dialog bg-white">
									<uni-view data-v-1a01b218="" class="cu-bar justify-end bg-green">
										<uni-view data-v-1a01b218="" class="content" style="font-weight: bold;">Join
											Green
										</uni-view>
									</uni-view>
												...
												<div class="uni-scroll-view" style="overflow: auto hidden;">
													<div class="uni-scroll-view-content">
														...
														<uni-view data-v-1a01b218="" data-id="0" id="sapre1"
															onclick="sapresel(1)" class="cu-item text-blue cur">10
														</uni-view>
									...
									<uni-view data-v-1a01b218="" class="cu-bar justify-end solids-top margin-top">
										<uni-view data-v-1a01b218="" class="action">
											<uni-button data-v-1a01b218="" id="sapreclose"
												class="cu-btn text-gray border">CLOSE
											</uni-button>
											<uni-button data-v-1a01b218="" onclick="gsapreproceed()"
							...
							<uni-view data-v-1a01b218="" data-v-91f724d0="" id="saprered" class="cu-modal ">
								<uni-view data-v-1a01b218="" class="cu-dialog bg-white">
												...
												<div class="uni-scroll-view" style="overflow: auto hidden;">
													<div class="uni-scroll-view-content">
														...
														<uni-view data-v-1a01b218="" data-id="0" id="sapre5"
															onclick="sapreselr(5)" class="cu-item text-blue cur">10
														</uni-view>
									...
									<uni-view data-v-1a01b218="" class="cu-bar justify-end solids-top margin-top">
										<uni-view data-v-1a01b218="" class="action">
											<uni-button data-v-1a01b218="" id="sapreclose3"
												class="cu-btn text-gray border">CLOSE
											</uni-button>
											<uni-button data-v-1a01b218="" onclick="rsapreproceed()"
												class="cu-btn text-blue border margin-left">
												CONFIRM</uni-button>
										</uni-view>
									</uni-view>
							...
							<uni-view data-v-1a01b218="" data-v-91f724d0="" id="sapreviobox" class="cu-modal ">
								<uni-view data-v-1a01b218="" class="cu-dialog bg-white">
												...
												<div class="uni-scroll-view" style="overflow: auto hidden;">
													<div class="uni-scroll-view-content">
														...
														<uni-view data-v-1a01b218="" data-id="0" id="sapre9"
															onclick="sapreselv(9)" class="cu-item text-blue cur">10
														</uni-view>
									...
									<uni-view data-v-1a01b218="" class="cu-bar justify-end solids-top margin-top">
										<uni-view data-v-1a01b218="" class="action">
											<uni-button data-v-1a01b218="" id="sapreclose1"
												class="cu-btn text-gray border">CLOSE
											</uni-button>
											<uni-button data-v-1a01b218="" onclick="vsapreproceed()"
												class="cu-btn text-blue border margin-left">
												CONFIRM</uni-button>
										</uni-view>
									</uni-view>
						...
						<uni-view data-v-5d7012ef="" class="cu-bar tabbar bg-white shadow foot">
							<uni-view data-v-5d7012ef="" data-cur="basics" class="action" onclick="window.location.href='indexlogin'">
								<uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
									<uni-image data-v-5d7012ef="">
										<div
											style="background-image: url(&quot;./win_files/basics.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
										</div><img src="./win_files/basics.png" draggable="true">
										<!---->
									</uni-image>
								</uni-view>
							...
							<uni-view data-v-5d7012ef="" data-cur="component" class="action" onclick="window.location.href='searchlogin'">
								<uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
									<uni-image data-v-5d7012ef="">
										<div
											style="background-image: url(&quot;./win_files/component.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
										</div><img src="./win_files/component.png" draggable="true">
										<!---->
									</uni-image>
								</uni-view>
								<uni-view data-v-5d7012ef="" class="text-gray">Search</uni-view>
							</uni-view>
							<uni-view data-v-5d7012ef="" data-cur="plugin" class="action">
								<uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
									<uni-image data-v-5d7012ef="">
										<div
											style="background-image: url(&quot;./win_files/plugin_cur.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
										</div><img src="./win_files/plugin_cur.png" draggable="true">
										<!---->
									</uni-image>
								</uni-view>
								<uni-view data-v-5d7012ef="" class="text-blue">Win</uni-view>
							</uni-view>
							<uni-view data-v-5d7012ef="" data-cur="personcenter" class="action" onclick="window.location.href='me'">
								<uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
									<uni-image data-v-5d7012ef="">
										<div
											style="background-image: url(&quot;./win_files/personcenter.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
										</div><img src="./win_files/personcenter.png" draggable="true">
										<!---->
									</uni-image>
								</uni-view>
								<uni-view data-v-5d7012ef="" class="text-gray">My</uni-view>
							</uni-view>
						</uni-view>
					</uni-view>
				</uni-page-body>
