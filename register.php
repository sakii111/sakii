...
?>
<!DOCTYPE html>
<!-- saved from url=(0044)https://lulumalls.co/#/pages/person/register -->
<html lang="zh-CN"
...
<head>
    ...
    <link rel="stylesheet" href="./register_files/index.e18c94d4.css">
    <script async="" src="./register_files/api.js.download"></script>
    <style type="text/css">
        @charset "UTF-8";
 ...
 */
    ...
    <script charset="utf-8" src="./register_files/pages-main.18ff6f50.js.download"></script>
    <style type="text/css">
    ...
    <script charset="utf-8" src="./register_files/pages-person-register.4db000b1.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
    ...
    <style type="text/css">
        .cb-title[data-v-79806f7c] {
            padding-left: inherit;
            position: absolute
        }

        .cb-title2[data-v-79806f7c] {
            /* padding: inherit; */
            /* position: absolute; */
            color: #09f
        }

        .btn-login[data-v-79806f7c] {
            width: 209px
        }
    </style>
</head>

<body class="uni-body pages-person-register"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
    <uni-app class="uni-app--maxwidth">
        <uni-page data-page="pages/person/register">
            <!---->
            <!---->
            <uni-page-wrapper>
                <uni-page-body>
                    <uni-view data-v-79806f7c="">
                        <uni-view data-v-3a572a86="" data-v-79806f7c="">
                            <uni-view data-v-3a572a86="" class="cu-custom" style="height: 52px;">
                                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue"
                                    style="height: 52px; padding-top: 0px;">
                                    <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='login'">
                                        <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>
                                        Register
                                    </uni-view>
                                    <!---->
                        ...
                        <uni-view data-v-79806f7c="" class="input-content">
                            <uni-view data-v-79806f7c="" class="cu-form-group"
                                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                                <uni-view data-v-79806f7c="" class="mobile lg cuIcon-mobilefill"></uni-view>
                                <uni-input data-v-79806f7c="" data-key="mobile">
                                    <div class="uni-input-wrapper">
                                        <div class="uni-input-placeholder input-placeholder" data-v-79806f7c=""></div>
                                        <input maxlength="140" placeholder="Mobile Numer" id="num" name="username"  step="" enterkeyhint="done"
                                            autocomplete="off" type="text" class="uni-input-input">
                                        <!---->
                                    </div>
                                </uni-input>
                            </uni-view>
                            <uni-view data-v-79806f7c="" class="cu-form-group"
                                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                                <uni-text data-v-79806f7c="" class="password lg cuIcon-commentfill"><span></span>
                                </uni-text>
                                <uni-input data-v-79806f7c="" data-key="code">
                                    <div class="uni-input-wrapper">
                                        <div class="uni-input-placeholder input-placeholder" data-v-79806f7c=""></div>
                                        <input maxlength="140" placeholder="Verification Code" name="otp" id="otp"
                                            step="0.000000000000000001" enterkeyhint="done" autocomplete="off"
                                            type="number" class="uni-input-input">
                                        <!---->
                                    </div>
                                </uni-input>
                                <uni-button data-v-79806f7c="" class="cu-btn shadow bg-blue"   onclick="sendcode()" id="otpbtn">OTP</uni-button>
                            </uni-view>
                            <uni-view data-v-79806f7c="" class="cu-form-group"
                                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                                <uni-text data-v-79806f7c="" class="password lg cuIcon-command"><span></span></uni-text>
                                <uni-input data-v-79806f7c="" minlength="6" data-key="password">
                                    <div class="uni-input-wrapper">
                                        <div class="uni-input-placeholder input-empty" data-v-79806f7c=""></div><input
                                            maxlength="20" placeholder="Password" id="pass" name="password"
                                                        type="password" step="" enterkeyhint="done"
                            ...
                            <uni-view data-v-79806f7c="" class="cu-form-group"
                                style="border: 1px solid whitesmoke; margin-bottom: 20px; border-radius: 30px;">
                                <uni-text data-v-79806f7c="" class="password lg cuIcon-goods"><span></span></uni-text>
                                <uni-input data-v-79806f7c="" data-key="recommendation">
                                    <div class="uni-input-wrapper">
                                        <div class="uni-input-placeholder input-empty" data-v-79806f7c=""
                                            style="display: none;"></div><input maxlength="140"id="code" name="refcode"
                                            placeholder="Recommendation Code" step="0.000000000000000001"
                        ...
                        <uni-checkbox-group data-v-79806f7c="" class="block">
                            <uni-view data-v-79806f7c="" class="cu-form-group margin-top">
                                <uni-checkbox data-v-79806f7c="" class="checked">
                                    <div class="uni-checkbox-wrapper">
                                        <div class="uni-checkbox-input uni-checkbox-input-checked"
                                            style="color: rgb(0, 122, 255);"></div>
                                    </div>
                                </uni-checkbox>
                                <uni-view data-v-79806f7c="" class="cb-title margin-left">|agree<uni-text
                                        data-v-79806f7c="" class="cb-title2 margin-left"><span>PRIVACY POLICY</span>
                                    </uni-text>
                                </uni-view>
                            </uni-view>
                        </uni-checkbox-group>
                        <uni-button data-v-79806f7c="" class="btn-login bg-blue margin-tb-sm lg"   onclick="sub()">Register</uni-button>
                        <uni-view data-v-79806f7c="" class="cu-bar tabbar bg-white shadow foot"
                            style="background-image: url(&quot;./register_files/menubg.png&quot;);">
                            <uni-view data-v-79806f7c="" data-cur="basics" class="action">
                                <uni-view data-v-79806f7c="" class="cuIcon-cu-image">
                                    <uni-image data-v-79806f7c="">
                                        <div
                                            style="background-image: url(&quot;./register_files/basics.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./register_files/basics.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-79806f7c="" class="text-gray">Home</uni-view>
                            </uni-view>
                            <uni-view data-v-79806f7c="" data-cur="component" class="action">
                                <uni-view data-v-79806f7c="" class="cuIcon-cu-image">
                                    <uni-image data-v-79806f7c="">
                                        <div
                                            style="background-image: url(&quot;./register_files/component.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./register_files/component.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-79806f7c="" class="text-gray">Games</uni-view>
                            </uni-view>
                            <!---->
                            <uni-view data-v-79806f7c="" data-cur="personcenter" class="action">
                                <uni-view data-v-79806f7c="" class="cuIcon-cu-image">
                                    <uni-image data-v-79806f7c="">
                                        <div
                                            style="background-image: url(&quot;./register_files/personcenter.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                        </div><img src="./register_files/personcenter.png" draggable="true">
                                        <!---->
                                    </uni-image>
                                </uni-view>
                                <uni-view data-v-79806f7c="" class="text-gray">My</uni-view>
                            </uni-view>
                        </uni-view>
                    </uni-view>
                </uni-page-body>
         ...
         <div id="snackbar" class="van-toast van-toast--middle van-toast--text" style="z-index: 2009;display:none "><div class="van-toast__text"></div></div>
        <!---->
        <!---->
        <uni-actionsheet>
    ...
    <script src="./register_files/chunk-vendors.8dd36274.js.download"></script>
    <script src="./register_files/index.547e89af.js.download"></script>
    <div
