...
<!-- App Capsule -->
<div id="appCapsule">
<form action="#" method="post" id="Register" class="" autocomplete="off">
  <div data-v-14ed88ba="" class="recharge_box">
				...
				<div data-v-14ed88ba="" class="special_box">
					...
					<button data-v-14ed88ba="" class="gocode" href="javascript:void(0);" id="reg_otp">OTP</button>
				</div>
				<div data-v-14ed88ba="" class="input_box">
					...
					<input data-v-14ed88ba="" type="password" placeholder="Password" name="password" id="password" style="color:rgba(0,0,0,.87);">
						<!--<span data-v-14ed88ba="" class="tips_span">Password is required</span>-->
				</div>
				<div data-v-14ed88ba="" class="input_box">
					<img data-v-14ed88ba="" src="data:image/png;base64," alt="" id="recomicon1">
					<img data-v-14ed88ba="" src="data:image/png;base64,
					ElFTkSuQmCC" alt="" style="display: none;" id="recomicon2">
					<input data-v-14ed88ba="" type="text" placeholder="Recommendation Code" name="rcode" id="rcode" value="<?php echo @$_GET['r_code'];?>" style="color:rgba(0,0,0,.87);">
				</div>
				...
				<div>
					<label class="container" for="remember">I agree <a data-toggle="modal" href="#privacy" data-backdrop="static" data-keyboard="false" style="color: #009688;">Privacy Policy</a>
				...
				<div data-v-14ed88ba="" class="input_box_btn">
					<button data-v-14ed88ba="" type="submit" class="login_btn ripple submit-button" id="chck">Register</button>
				</div>
			</div>
</form>
</div>
...
<script>
	...
	var urcode = document.getElementById("rcode");
	var recomicon1 = document.getElementById("recomicon1");
	var recomicon2 = document.getElementById("recomicon2");
	...
	umobile.addEventListener("click", function(event){
		...
		recomicon1.style.display="";
		recomicon2.style.display="none";
	...
	urcode.addEventListener("click", function(event){
		event.stopPropagation();
		passicon1.style.display="";
		passicon2.style.display="none";
		mobicon1.style.display="";
		...
		otpicon1.style.display="";
		otpicon2.style.display="none";
		recomicon1.style.display="none";
		recomicon2.style.display="";
		
		urcode.style.caretColor="#9C27B0";
	});
	
	document.addEventListener("click", function(event) {
		if (!event.target.matches("#umobile, #uotp, #upassword, #urcode")) {
			passicon1.style.display = "";
			passicon2.style.display = "none";
			mobicon1.style.display = "";
			mobicon2.style.display = "none";
