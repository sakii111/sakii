...
$sql = "SELECT  t_sup,t_grp FROM notice WHERE id='1'";
...
<!DOCTYPE html>
<!-- saved from url=(0045)https://lulumalls.co/#/pages/person/complaint -->
<html lang="zh-CN"
...
<head>
    ...
    <link rel="stylesheet" href="./help_files/index.e18c94d4.css">
    <script async="" src="./help_files/invisible.js.download"></script>
    <style type="text/css">
        @charset "UTF-8";
...
*/
 ...
 ==================== */
        ...
        .cu-load.load-modal {
            ...
            border-radius: 5px;
            box-shadow: 0 0 0px 1024px rgba(0, 0, 0, .5);
            display: -webkit-box;
            display: -webkit-flex;
            display: flex;
            -webkit-box-align: center;
 ...
 ==================== */
        ...
        .cu-list.menu-avatar>.cu-item .content {
            position: absolute;
            left: 74px;
            width: calc(100% - 49px - 30px - 61px - 10px);
            line-height: 1.6em
        }

        .cu-list.menu-avatar>.cu-item .content.flex-sub {
            width: calc(100% - 49px - 30px - 10px)
        }
 ...
 ==================== */
        ...
        .cu-bar.tabbar {
            padding: 0;
            height: calc(51px + env(safe-area-inset-bottom) / 2);
 ...
 */
    ...
    <style type="text/css">
        ...
        .my-header-height[data-v-43d18a05] {
            min-height: 28px;
            height: calc(28px + env(safe-area-inset-bottom) / 2)
        }
    </style>
    <style type="text/css">
 ...
 */
    ...
    <script charset="utf-8" src="./help_files/pages-main.18ff6f50.js.download"></script>
    <style type="text/css">
    ...
    <script charset="utf-8" src="./help_files/pages-person-address.94d56827.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
...
.btn-del{
    ...
    <script charset="utf-8" src="./help_files/pages-person-addAddress.5f4647cb.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
    ...
    <script charset="utf-8" src="./help_files/pages-person-complaint.0030a6a2.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
    ...
    <style type="text/css">
        .left-info[data-v-b9c25fd2] {
            position: absolute;
            left: 5px
        }

        .right-info[data-v-b9c25fd2] {
            position: absolute;
            right: 5px
        }

        .my-lottery-info[data-v-b9c25fd2] {
            position: absolute;
            /*相对父节点 绝对位置*/
            right: 15px
        }

        .my-space-x[data-v-b9c25fd2] {
            margin-right: 10px
        }
    </style>
    <script charset="utf-8" src="./help_files/pages-person-withdrawal.d8997760.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
    ...
    <style type="text/css">
        .menu[data-v-0cc5f2c3] {
            position: absolute;
            right: 10px
                /* top:20upx; */
        }

        .title[data-v-0cc5f2c3] {
            position: absolute;
            left: 51px
        }

        .btn-recharge[data-v-0cc5f2c3] {
            width: 204px;
            height: 51px
                /* position: relative; */
        ...
        .fee-text[data-v-0cc5f2c3] {
            position: relative;
            margin-left: 51px;
            margin-top: -46px
        }

        .password-text[data-v-0cc5f2c3] {
            color: #fff
        }

        .payout-text[data-v-0cc5f2c3] {
            /* color:#333333;
position: absolute;
left: 60upx;
top: 320upx; */
    ...
    <script charset="utf-8" src="./help_files/pages-person-withdrawalRecord.51c0214a.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
    ...
    <style type="text/css">
        .my-textsize[data-v-91c0d9e6] {
            font-size: 10px
        }

        .padding-xl[data-v-91c0d9e6] {
            padding: 10px
        }

        .my-text[data-v-91c0d9e6] {
            position: absolute;
            /*相对父节点 绝对位置*/
            right: 25px;
            top: 92px
        ...
        .my-lottery-info[data-v-91c0d9e6] {
            position: absolute;
            right: 15px
        }

        .my-space-x[data-v-91c0d9e6] {
            margin-right: 10px
        }
    </style>
    <style type="text/css">
    ...
    <script charset="utf-8" src="./help_files/pages-person-addBank.503f93de.js.download"></script>
    <style type="text/css">
        .uni-app--showtabbar uni-page-wrapper {
            display: block;
            height: calc(100% - 50px);
...
<body class="uni-body pages-person-complaint"><noscript><strong>Please enable JavaScript to
            continue.</strong></noscript>
    <uni-app class="uni-app--maxwidth">
        <uni-page data-page="pages/person/complaint">
            <!---->
            <!---->
            <uni-page-wrapper>
                <uni-page-body>
                    <uni-view data-v-b9c25fd2="">
                        <uni-view data-v-3a572a86="" data-v-b9c25fd2="">
                            <uni-view data-v-3a572a86="" class="cu-custom" style="height: 51px;">
                                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue"
                                    ...
                                    <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='me'">
                                        <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>Add
                                    ...
                                    <!---->
                                        ...
                                        <uni-view 
                                style="border: solid 4px; border-color: rgb(252, 39, 121);border-radius: 102px;background: bisque;
    padding: 20px;margin-top: 15px;
    text-align: center;"onclick="window.location.href='https://t.me/<?php echo  $support?>'">
                                <uni-text
                                    style="color: rgb(0, 0, 0);"><span>Chat</span></uni-text>
                            </uni-view>
                              <uni-view 
                                style="border: solid 4px; border-color: rgb(252, 39, 121);border-radius: 102px;background: bisque;
    padding: 20px; margin-top: 15px;
    text-align: center;"onclick="window.location.href='https://t.me/<?php echo  $group?>'">
                                <uni-text
                                    style="color: rgb(0, 0, 0);"><span>Prediction group</span></uni-text>
                            </uni-view>
                            
                        <uni-view data-v-b9c25fd2="" class="cu-modal">
                           
                        </uni-view>
                        <uni-view data-v-b9c25fd2="" class="cu-tabbar-height"></uni-view>
                    </uni-view>
                </uni-page-body>
            </uni-page-wrapper>
        </uni-page>
    ...
    <script src="./help_files/chunk-vendors.8dd36274.js.download"></script>
    <script src="./help_files/index.547e89af.js.download"></script>
    <div
