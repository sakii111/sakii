...
?>
<!DOCTYPE html>
<!-- saved from url=(0045)https://lulumalls.co/#/pages/person/promotion -->
<html lang="zh-CN"
...
<head>
    ...
    <link rel="stylesheet" href="./invite_files/index.e18c94d4.css">
...
.right-info{
    ...
    <style type="text/css">
        .my-textsize[data-v-dceb48ea] {
            font-size: 10px
        }

        .padding-xl[data-v-dceb48ea] {
            padding: 10px
        }

        .my-text[data-v-dceb48ea] {
            position: absolute;
            /*相对父节点 绝对位置*/
            right: 26px;
            top: 94px
        ...
        .my-lottery-info[data-v-dceb48ea] {
            position: absolute;
            right: 15px
        }

        .my-space-x[data-v-dceb48ea] {
            margin-right: 10px
        }
    </style>
...
<body class="uni-body pages-person-promotion"><noscript><strong>Please enable JavaScript to
            continue.</strong></noscript>
    <uni-app class="uni-app--maxwidth">
        <uni-page data-page="pages/person/promotion">
            <!---->
            <!---->
            <uni-page-wrapper>
                <uni-page-body>
                    <uni-view data-v-65b1d64e="">
                        <uni-view data-v-3a572a86="" data-v-65b1d64e="">
                        ...
                        <uni-view data-v-65b1d64e="" class="bg-white">
                            <uni-view data-v-65b1d64e="" class="title text-center padding">Bonus:₹ <?php echo $bon?></uni-view>
                            <uni-view data-v-65b1d64e="" class="flex justify-center">
                                <uni-button data-v-65b1d64e="" class="cu-btn bg-blue radius" onclick="apply()">Apply to Balance
                                </uni-button>
                            </uni-view>
                            <uni-scroll-view data-v-65b1d64e="" class="bg-white nav text-center padding"
                                style="top: 100px;">
                                <div class="uni-scroll-view">
                                    <div class="uni-scroll-view" style="overflow: auto hidden;">
                                        <div class="uni-scroll-view-content">
                                            <!---->
                                            <uni-view data-v-65b1d64e="" data-id="0" id="bl1" class="cu-item text-blue cur" onclick="l1()">
                                                Level1</uni-view>
                                            <uni-view data-v-65b1d64e="" data-id="1" id="bl2" class="cu-item" onclick="l2()">Level2</uni-view>
                                        </div>
                                    </div>
                                </div>
                            </uni-scroll-view>
                            <uni-view data-v-65b1d64e="" class="flex justify-between text-center" id="level1">
                                <uni-view data-v-65b1d64e="" class="margin-left text-gray">TotalPeople<uni-view
                                        data-v-65b1d64e="" class="margin-left padding text-black"><?php echo $rowcount; ?></uni-view>
                                </uni-view>
                                <uni-view data-v-65b1d64e="" class="margin-right text-gray">Contribution<uni-view
                                        data-v-65b1d64e="" class="margin-right padding text-black"><?php echo $bonus?></uni-view>
                                </uni-view>
                            </uni-view>
                                 <uni-view data-v-65b1d64e="" class="flex justify-between text-center" id="level2" style="display:none;">
                                <uni-view data-v-65b1d64e="" class="margin-left text-gray">TotalPeople<uni-view
                                        data-v-65b1d64e="" class="margin-left padding text-black"><?php echo $rowcount2; ?></uni-view>
                                </uni-view>
                                <uni-view data-v-65b1d64e="" class="margin-right text-gray">Contribution<uni-view
                                        data-v-65b1d64e="" class="margin-right padding text-black"><?php echo $bonus2?></uni-view>
                                </uni-view>
                            </uni-view>
                            <uni-view data-v-65b1d64e="" class="margin-left text-gray padding-xs">My Promotion Code
                            </uni-view>
                            <uni-view data-v-65b1d64e="" class="solid-bottom margin-left padding-xs"><span id="code" ><?php echo  $_SESSION['usercode']?></span></uni-view>
                            <uni-view data-v-65b1d64e="" class="margin-left text-gray padding-xs">My Promotion Link
                            </uni-view>
                            <uni-view data-v-65b1d64e="" class="solid-bottom margin-left padding-xs">
                                <span id="link" >https://malinimall.in/register?r_code=<?php echo  $_SESSION['usercode']?></span></uni-view>
                            <uni-view data-v-65b1d64e="" class="flex justify-center padding">
                                <uni-button data-v-65b1d64e="" class="cu-btn lg radius shadow shadow-lg margin-right"  onclick="copyToClipboard(link)">
                                    Copy Link</uni-button>
                                <uni-button data-v-65b1d64e="" class="cu-btn lg radius shadow shadow-lg text-blue" onclick="window.location.href='register?code=<?php echo  $_SESSION['usercode']?>'">Open
                                    Link</uni-button>
                            </uni-view>
                        </uni-view>
                        <uni-view data-v-65b1d64e="" class="cu-modal">
                            <uni-view data-v-65b1d64e="" class="cu-dialog bg-white">
                                <uni-view data-v-65b1d64e="" class="bg-gray">
                                    <uni-view data-v-65b1d64e="" class="text-left margin-left padding-sm">Apply to
                                        Balance</uni-view>
                                    <uni-view data-v-65b1d64e="" class="cu-form-group"
                                        style="border: 1px solid whitesmoke; border-radius: 0px;">
                                        <uni-input data-v-65b1d64e="" data-key="inputBonus">
                                            <div class="uni-input-wrapper">
                                                <div class="uni-input-placeholder input-placeholder" data-v-65b1d64e="">
                                                    Bonus</div><input maxlength="140" step="0.000000000000000001"
                                ...
                                <uni-view data-v-65b1d64e="" class="padding-sm"></uni-view>
                                <uni-button data-v-65b1d64e=""
                                    class="btnApply cu-btn radius shadow shadow-lg padding-sm">Apply All</uni-button>
                                <uni-view data-v-65b1d64e="" class="flex justify-end padding-sm">
                                    <uni-view data-v-65b1d64e="" class="text-gray border">CANCEL</uni-view>
                                    <uni-view data-v-65b1d64e="" class="text-blue border margin-left">CONFIRM</uni-view>
                                </uni-view>
                            </uni-view>
                        </uni-view>
                    </uni-view>
        ...
        <div id="snackbar" class="show" style="display:none"></div>
        <!---->
        <!---->
        <uni-actionsheet>
...
inputc.parentNode.removeChild(inputc);
  document.getElementById("snackbar").innerHTML= "Copied";
  ...
  function l1(){
       ...
       document.getElementById("bl1").className= "cu-item text-blue cur";
      
       document.getElementById("bl2").className= "cu-item";

    }
    function l2(){
       document.getElementById("level1").style.display= "none";
       document.getElementById("level2").style.display= "";        
       document.getElementById("bl1").className= "cu-item";

       document.getElementById("bl2").className= "cu-item text-blue cur";
       ...
       function apply(){
           if(<?php echo $bon?> >0){
               ...
               document.getElementById("snackbar").innerHTML= "No Bonous to Apply";
           document.getElementById("snackbar").style.display= "";
        setTimeout(function () { document.getElementById("snackbar").style.display= "none"; }, 3000); 
           }
       }
