...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    exit;
                        ...
                        $sql = "SELECT  account, ifsc,name FROM users  WHERE username='".$_SESSION['username']."'";
...
?>
<!DOCTYPE html>
<!-- saved from url=(0040)https://lulumalls.co/#/pages/person/bank -->
<html lang="zh-CN"
...
<head>
  ...
  <link rel="stylesheet" href="./bank_files/index.e18c94d4.css">
 ...
 */
  ...
  <style type="text/css">
    ...
    .infoIcon[data-v-10658df3] {
      position: absolute;
      left: 10px;
      line-height: 31px
    }

    .infoCard[data-v-10658df3] {
      position: absolute;
      left: 41px;
      line-height: 31px
    }

    .info-edit[data-v-10658df3] {
      position: absolute;
      right: 26px;
      line-height: 31px
        /*与父亲节点同一高度，设置垂直居中*/
...
.btn-del{
  ...
  <style type="text/css">
    ...
    .infoIcon[data-v-23d644b4] {
      position: absolute;
      left: 10px;
      line-height: 62px
    }

    .infoCard[data-v-23d644b4] {
      position: absolute;
      left: 41px;
      line-height: 31px
    }

    .info-edit[data-v-23d644b4] {
      position: absolute;
      right: 26px;
      line-height: 62px
        /*与父亲节点同一高度，设置垂直居中*/
...
<body class="uni-body pages-person-bank"><noscript><strong>Please enable JavaScript to continue.</strong></noscript>
  <uni-app class="uni-app--maxwidth">
    <uni-page data-page="pages/person/bank">
      <!---->
      <!---->
      <uni-page-wrapper>
        <uni-page-body>
          <uni-view data-v-10658df3="">
            <uni-view data-v-3a572a86="" data-v-10658df3="">
              <uni-view data-v-3a572a86="" class="cu-custom" style="height: 52px;">
                <uni-view data-v-3a572a86="" class="cu-bar fixed bg-blue" style="height: 52px; padding-top: 0px;">
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='me'">
                    <uni-text data-v-3a572a86="" class="cuIcon-back"><span></span></uni-text>Bank Card
                  </uni-view>
                  <!---->
                  <uni-view data-v-3a572a86="" class="content" style="top: 0px;"></uni-view>
                  <!---->
                  <uni-view data-v-3a572a86="" class="action" onclick="window.location.href='card'">
                    <uni-text data-v-3a572a86="" class="cuIcon-add"><span></span></uni-text>
                  </uni-view>
                  <!---->
                </uni-view>
              </uni-view>
            </uni-view>
            <uni-view data-v-10658df3="" class="margin-bottom text-center padding-x solid-top" id="bank">
              <uni-view data-v-10658df3="" class="bankInfo margin-tb-sm has-bg-white" style="height: 31px;">
                <uni-text data-v-10658df3="" class="infoIcon cuIcon-card"><span></span></uni-text>
                <uni-text data-v-10658df3="" class="infoCard"><span><?php echo $row["name"];?></span></uni-text>
                <uni-text data-v-10658df3="" data-id="261079" class="info-edit cuIcon-info" onclick="edit()"><span></span></uni-text>
              </uni-view>
            </uni-view>
            <uni-view data-v-10658df3="" id="edit"  class="cu-modal">
              <uni-view data-v-10658df3="" onclick="close()"  class="selectDialog cu-dialog justify-center">
                <uni-view data-v-10658df3="" class="text-left">
                  <uni-view data-v-10658df3="">
                    <uni-text data-v-10658df3="" class="modal-title padding-xs block"><span>Select</span></uni-text>
                  </uni-view>
                  <uni-view data-v-10658df3="" class="padding block">
                    <uni-button data-v-10658df3="" class="btn-edit cu-btn bg-white cuIcon-writefill" onclick="window.location.href='bankcard'">Edit</uni-button>
                  </uni-view>
                  <uni-view data-v-10658df3="" class="padding block">
                    <uni-button data-v-10658df3="" class="btn-del cu-btn bg-white cuIcon-deletefill" onclick="deleteb()">Delete</uni-button>
                  </uni-view>
                </uni-view>
              </uni-view>
            </uni-view>
            <uni-view data-v-10658df3="" id="delete" class="cu-modal">
              <uni-view data-v-10658df3="" class="delDialog cu-dialog">
                <uni-view data-v-10658df3="" class="text-left bg-white">
                  <uni-view data-v-10658df3="" class="cu-bar bg-white justify-end">
                    <uni-view data-v-10658df3="" class="content" style="font-weight: bold;">Confirm</uni-view>
                  </uni-view>
                  <uni-view data-v-10658df3="">
                    <uni-text data-v-10658df3="" class="logout-text"><span>Do you want to delete this bank card?</span>
                    </uni-text>
                  </uni-view>
                  <uni-view data-v-10658df3="">
                    <uni-text data-v-10658df3="" class="delete-text"><span></span></uni-text>
                  </uni-view>
                  <uni-view data-v-10658df3="" class="flex justify-end padding">
                    <uni-button data-v-10658df3="" class="cu-btn text-gray border" onclick="deletebclose()">CANCEL</uni-button>
                    <uni-button data-v-10658df3="" class="cu-btn text-blue border margin-left" onclick="window.location.href='bankdelete'">DELETE</uni-button>
                  </uni-view>
                </uni-view>
              </uni-view>
            </uni-view>
            <uni-view data-v-10658df3="" class="cu-tabbar-height"></uni-view>
          </uni-view>
        </uni-page-body>
      </uni-page-wrapper>
    </uni-page>
...
<script>
  ...
  function edit(){
    document.getElementById("edit").className="cu-modal show"
  }
   function deleteb(){
    document.getElementById("delete").className="cu-modal show"
  }
    function deletebclose(){
    document.getElementById("delete").className="cu-modal"
  }
  modal=document.getElementById("edit");
  window.onclick = function(event) {
  if (event.target == modal) {
    document.getElementById("edit").className="cu-modal"
  }
}
