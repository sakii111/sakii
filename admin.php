...
">Jhon Doe</h6>
        ...
        <div class="content">
            ...
            <br>
            <div>
           <button style="font-size:20px; padding:5px 32px; color:Black; margin-left: 250px; text-align:center;"onclick="window.location.href='getdetails'"> User Details</button>
            <button style="font-size:20px;padding:5px; margin-left: 30px; color:Black; text-align:center;"onclick="window.location.href='gift'">Create Gift Card</button>
                 <button style="font-size:20px;padding:5px; margin-left: 30px; color:black; text-align:center;"onclick="window.location.href='notice'">Update Notice</button>
                 </div>
                 <br>
                 <button style="font-size:20px;padding:5px 36px; margin-left: 250px; color:black; text-align:center;"onclick="window.location.href='block'">Block User</button>
                 <button style="font-size:20px;padding:5px 20px;  margin-left: 30px; color:black; text-align:center;"onclick="window.location.href='unblock'">Unblock User</button>
                  <button style="font-size:20px;padding:5px; margin-left: 30px; color:black; text-align:center;"onclick="window.location.href='updateperiod'">Update Period</button>
                  <br>
                  <br>
                   <button style="font-size:20px;padding:5px 32px; margin-left: 250px; color:black; text-align:center;"onclick="window.location.href='updateotp'">Update OTP</button>
                    <button style="font-size:20px;padding:5px 10px; margin-left: 30px; color:black; text-align:center;"onclick="window.location.href='updateadmin'">Change Admin Password</button>
                    <button style="font-size:20px;padding:5px; margin-left: 30px; color:black; text-align:center;"onclick="window.location.href='rechrec'">Recharge History</button>
                    <br>
                    <br>
                    <button style="font-size:20px;padding:5px; margin-left: 250px; color:black; text-align:center;"onclick="window.location.href='withrecord'">Withdraw History</button>
                    <button style="font-size:20px;padding:5px; margin-left: 30px; color:black; text-align:center;"onclick="window.location.href='giftrec'">Lifafa History</button>
                    <br>
                    <br>
                    
                    <h3 style="font-size:20px;padding:5px;  color:Green; text-align:center;">User's Game Result's</h3>
                   <br>
                    <br>
                    <button style="font-size:20px;padding:5px; margin-left: 250px; color:Red; text-align:center;"onclick="window.location.href='fastpresult'"> Fast Parity Result</button>
            <button style="font-size:20px;padding:5px; margin-left: 30px; color:Red; text-align:center;"onclick="window.location.href='parity1'"> Parity Result</button>
                    <button style="font-size:20px;padding:5px; margin-left: 30px; color:Red; text-align:center;"onclick="window.location.href='diceresult'">Dice Result</button>
                    <br><br>
                 <button style="font-size:20px;padding:5px; margin-left: 250px; color:Red; text-align:center;"onclick="window.location.href='abresult'">Andar Bhar Result</button>
                 <button style="font-size:20px;padding:5px; margin-left: 30px; color:Red; text-align:center;"onclick="window.location.href='circleresult'"> Circle Result</button>
...
">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="https://wa.me/">lovely</a>
