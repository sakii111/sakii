    ...
    ["chunk-vendors"], {
            ...
            (function (t) {
                ...
                function ie(t, e, n) {
                    if (V.errorHandler) try {
                        ...
                        ka !== t && re(ka, null, "config.php.errorHandler")
                    }
                    re(t, e, n)
                }
                ...
                function Mi(t) {
                    ...
                    Object.defineProperty(t, "config.php", e), t.util = {
                        warn: dt,
                        extend: A,
                        mergeOptions: Yt,
                        defineReactive: Pt
                ...
                ki.config.php.mustUseProp = Ri, ki.config.php.isReservedTag = or, ki.config.php.isReservedAttr = Li, ki.config.php.getTagNamespace = ar, ki.config.php.isUnknownElement = cr, A(ki.options.directives, sa), A(ki.options.components, wa), ki.prototype.__patch__ = G ? Go : B, ki.prototype.$mount = function (t, e) {
        ...
        "2f62": function (t, e, n) {
            ...
            (function (t) {
                ...
                var g = function (t) {
                        ...
                        var l = void 0 !== t.devtools ? t.devtools : m.config.php.devtools;
                        l && o(this)
                    },
                    b = {
                        state: {
                ...
                function S(t, e, n) {
                    ...
                    var a = m.config.php.silent;
                    m.config.php.silent = !0, t._vm = new m({
                        data: {
                            $$state: e
                        },
                        computed: o
                    }), m.config.php.silent = a, t.strict && T(t), i && (n && t._withCommit(function () {
                        i._data.$$state = null
                    }), m.nextTick(function () {
                        return i.$destroy()
                    }))
        ...
        "387f": function (t, e, n) {
            ...
            t.exports = function (t, e, n, i, r) {
                return t.config.php = e, n && (t.code = n), t.request = i, t.response = r, t.isAxiosError = !0, t.toJSON = function () {
                    return {
        ...
        "467f": function (t, e, n) {
            ...
            var i = n("2d83");
            t.exports = function (t, e, n) {
                var r = n.config.php.validateStatus;
                !r || r(n.status) ? t(n) : e(i("Request failed with status code " + n.status, n.config.php, null, n.request, n))
            }
        },
        "46a7": function (t, e, n) {
            var i = n("63b6");
        ...
        "8c4f": function (t, e, n) {
            ...
            var s = {
                ...
                render: function (t, e) {
                    ...
                    if (o.routerViewDepth = f, d) {
                        var v = h[u],
                            m = v && v.component;
                        return m ? (v.config.phpProps && c(m, o, v.route, v.config.phpProps), s(m, o, i)) : s()
                    }
                    var g = l.matched[f],
                        b = g && g.components[u];
            ...
            function ct(t) {
                if (!ct.installed || et !== t) {
                    ...
                    var i = t.config.php.optionMergeStrategies;
                    ...
                    var i = n(0),
                        ...
                        a = function () {
                            function t(t, e) {
                                for (var n = 0; n < e.length; n++) {
                                    var i = e[n];
                                    i.enumerable = i.enumerable || !1, i.config.phpurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(t, i.key, i)
                                }
                            }
                            return function (e, n, i) {
        ...
        b970: function (t, e, n) {
            ...
            function ii(t, e, n, i) {
                ...
                function u() {
                    return "add" === r ? e.addText || ni("addText") : [t("div", [ni("name") + "ï¼š" + e.name]), t("div", [ni("tel") + "ï¼š" + e.tel])]
                }
                return t(ht, o()([{
                    attrs: {
                        center: !0,
                ...
                Ks = {
                    "zh-CN": {
                        vanSku: {
                            select: "è¯·é€‰æ‹©",
                            selected: "å·²é€‰",
                            selectSku: "è¯·å…ˆé€‰æ‹©å•†å“è§„æ ¼",
                            soldout: "åº“å­˜ä¸è¶³",
                            originPrice: "åŽŸä»·",
                            minusTip: "è‡³å°‘é€‰æ‹©ä¸€ä»¶",
                            minusStartTip: function (t) {
                                return t + "ä»¶èµ·å”®"
                            },
                            unavailable: "å•†å“å·²ç»æ— æ³•è´­ä¹°å•¦",
                            stock: "å‰©ä½™",
                            stockUnit: "ä»¶",
                            quotaTip: function (t) {
                                return "æ¯äººé™è´­" + t + "ä»¶"
                            ...
                            quotaUsedTip: function (t, e) {
                                return "æ¯äººé™è´­" + t + "ä»¶ï¼Œä½ å·²è´­ä¹°" + e + "ä»¶"
                            }
                        },
                        vanSkuActions: {
                            buy: "ç«‹å³è´­ä¹°",
                        ...
                        vanSkuImgUploader: {
                            oversize: function (t) {
                                return "æœ€å¤§å¯ä¸Šä¼ å›¾ç‰‡ä¸º" + t + "MBï¼Œè¯·å°è¯•åŽ‹ç¼©å›¾ç‰‡å°ºå¯¸"
                            },
                            fail: "ä¸Šä¼ å¤±è´¥<br />é‡æ–°ä¸Šä¼ "
                        },
                        vanSkuStepper: {
                        ...
                        vanSkuMessages: {
                            ...
                            imageLabel: "ä»…é™ä¸€å¼ ",
                            invalid: {
                                tel: "è¯·å¡«å†™æ­£ç¡®çš„æ•°å­—æ ¼å¼ç•™è¨€",
                                mobile: "æ‰‹æœºå·é•¿åº¦ä¸º6-20ä½æ•°å­—",
                                email: "è¯·å¡«å†™æ­£ç¡®çš„é‚®ç®±",
                                id_no: "è¯·å¡«å†™æ­£ç¡®çš„èº«ä»½è¯å·ç "
                            },
                            placeholder: {
                                id_no: "è¾“å…¥èº«ä»½è¯å·ç ",
                                text: "è¾“å…¥æ–‡æœ¬",
                                tel: "è¾“å…¥æ•°å­—",
                                email: "è¾“å…¥é‚®ç®±",
                                date: "ç‚¹å‡»é€‰æ‹©æ—¥æœŸ",
                                time: "ç‚¹å‡»é€‰æ‹©æ—¶é—´",
                                textarea: "ç‚¹å‡»å¡«å†™æ®µè½æ–‡æœ¬",
                                mobile: "è¾“å…¥æ‰‹æœºå·ç "
                            }
                        },
                        vanSkuRow: {
            ...
            var Nc = $c({
                ...
                zc = Mc({
                    props: {
                        ...
                        customStepperconfig.php: Object,
                    ...
                    computed: {
                        ...
                        quotaText: function () {
                            var t = this.customStepperconfig.php,
                                e = t.quotaText,
                                n = t.hideQuotaText;
                            if (n) return "";
                            var i = "";
                    ...
                    methods: {
                        ...
                        onChange: function (t) {
                            var e = parseInt(t, 10),
                                n = this.customStepperconfig.php.handleStepperChange;
                    ...
                    methods: {
                        ...
                        getPlaceholder: function (t) {
                            var e = 1 === +t.multiple ? "textarea" : t.type,
                                n = this.messageconfig.php.placeholderMap || {};
                        ...
                        genMessage: function (t, e) {
                            ...
                            return "image" === t.type ? i(ht, {
                                ...
                                attrs: {
                                    maxSize: this.messageconfig.php.uploadMaxSize,
                                    uploadImg: this.messageconfig.php.uploadImg
                                },
                                model: {
            ...
            var pu = lu(du),
                ...
                xu = mu({
                    ...
                    computed: {
                        ...
                        stock: function () {
                            var t = this.customStepperconfig.php.stockNum;
                            return void 0 !== t ? t : this.selectedSkuComb ? this.selectedSkuComb.stock_num : this.sku.stock_num
                        },
                        stockText: function () {
                            var t = this.$createElement,
                                e = this.customStepperconfig.php.stockFormatter;
                    ...
                    methods: {
                        ...
                        onOverLimit: function (t) {
                            var e = t.action,
                                ...
                                i = t.quota,
                                r = t.quotaUsed,
                                o = this.customStepperconfig.php.handleOverLimit;
                    ...
                    render: function () {
                        ...
                        if (!this.isSkuEmpty) {
                            var n = this.sku,
                                ...
                                }, [this.priceTag])]), m("sku-header-origin-price") || a && e(mc, [bu("originPrice"), " ï¿¥", a]), !this.hideStock && e(mc, [e("span", {
                                ...
                                y = m("sku-stepper") || e(zc, {
                                    ...
                                    attrs: {
                                        ...
                                        customStepperconfig.php: this.customStepperconfig.php,
                                ...
                                x = m("sku-messages") || e(cu, {
                                    ...
                                    attrs: {
                                        goodsId: this.goodsId,
                                        messageconfig.php: this.messageconfig.php,
                                        messages: n.messages
                                    }
                                }),
