...
while($row2 = mysqli_fetch_array($result2))
{
  $alink='"/accept?am='.$row2[2].'&utr='.$row2[6].'&un='.$row2[1].'"';
    ...
    $dataRow = $dataRow."<tr><td >$row2[0]</td><td >$row2[1]</td><td>$row2[4]</td><td >$row2[5]</td><td onclick='window.location.href=$image;' style='background:green;'><img src=$image style='height: 50px' ></td><td>$row2[2]</td><td>$row2[3]</td></tr>";
}
