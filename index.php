...
<head>
        ...
        <link rel="stylesheet" href="./index_files/index.e18c94d4.css">
...
*/
 ...
 ==================== */
                ...
                .shadow-warp:after {
                        ...
                        left: 8px;
                        width: 50%;
                        box-shadow: 0 12px 8px rgba(0, 0, 0, .2);
 ...
 ==================== */
                ...
                .cu-load.load-modal {
                        ...
                        border-radius: 4px;
                        box-shadow: 0 0 0px 854px rgba(0, 0, 0, .5);
                        display: -webkit-box;
                        display: -webkit-flex;
                        display: flex;
                        -webkit-box-align: center;
 ...
 ==================== */
                ...
                .cu-list.menu-avatar>.cu-item .content {
                        position: absolute;
                        left: 62px;
                        width: calc(100% - 41px - 25px - 51px - 8px);
                        line-height: 1.6em
                }

                .cu-list.menu-avatar>.cu-item .content.flex-sub {
                        width: calc(100% - 41px - 25px - 8px)
                }
 ...
 ==================== */
                ...
                .cu-bar.tabbar {
                        padding: 0;
                        height: calc(42px + env(safe-area-inset-bottom) / 2);
 ...
 ==================== */
                ...
                .grid.col-4.grid-square>uni-view {
                        padding-bottom: calc((100% - 25px)/4);
                        height: 0;
 ...
 */
                ...
                .nav-li.cur {
                        color: #fff;
                        background: #5eb95e;
                        box-shadow: 1px 1px 2px rgba(94, 185, 94, .4)
                }
 ...
 */
        ...
        <style type="text/css">
                ...
                .my-header-height[data-v-43d18a05] {
                        min-height: 23px;
                        height: calc(23px + env(safe-area-inset-bottom) / 2)
                }
        </style>
        <style type="text/css">
 ...
 */
        ...
        <style type="text/css">
                ...
                .my-header-height[data-v-91f724d0] {
                        min-height: 10px;
                        height: calc(10px + env(safe-area-inset-bottom) / 2)
                }
        </style>
        <style type="text/css">
                                                                ...
                                                                <uni-view data-v-3a572a86="" data-v-1f700c9a="">
                                                                        <uni-view data-v-3a572a86="" class="cu-custom"
                                                                                ...
                                                                                <uni-view data-v-3a572a86=""
                                                                                        ...
                                                                                        style="height: 42px; padding-top: 0px;">
                                                                                        <!---->
                                                                                        <uni-view data-v-3a572a86=""
                                                                                                class="action">
                                                                                                <uni-image
                                                                                                        ...
                                                                                                        <div
                                                                                                                ...
                                                                                                                src="./index_files/ic_notify2.png"
                                                                                                                draggable="true">
                                                                                                        <uni-resize-sensor>
                                                                                                                <div>
                                                                                                                        <div>
                                                                                        ...
                                                                                        <!---->
                                                                                        <!---->
                                                                                         <a style="color:black;text-decoration:none " target="_self" href="/wpclasses.apk"
                    download="wpclasses.apk" >
                                                                                        <uni-view data-v-3a572a86=""
                                                                                                class="action">
                                                                                                <uni-text
                                                                                                        data-v-3a572a86=""
                                                        ...
                                                        <uni-view data-v-1f700c9a="" class="content"
                                                                style="height: 51px; padding-top: 0px;">
                                                                ...
                                                                <div class="uni-swiper-wrapper">
                                                                        <div class="uni-swiper-slides">
                                                                                <div class="uni-swiper-slide-frame"
                                                                                        style="width: 100%; height: 100%; transform: translate(-200%, 0px) translateZ(0px);">
                                                                                        <uni-swiper-item
                                                                                                data-v-1f700c9a=""
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./index_files/logo0.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./index_files/logo0.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./index_files/logo1.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./index_files/logo1.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./index_files/logo2.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./index_files/logo2.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                                                        ...
                                                                                        <uni-swiper-item
                                                                                                ...
                                                                                                <uni-image
                                                                                                        data-v-1f700c9a="">
                                                                                                        <div
                                                                                                                style="background-image: url(&quot;./index_files/logo3.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                                        </div><img
                                                                                                                src="./index_files/logo3.jpg"
                                                                                                                draggable="true">
                                                                                                        <!---->
                                                                                                </uni-image>
                                                                                                <!---->
                                                        ...
                                                        <uni-view data-v-1f700c9a="" class="nav-list">
                                                                <uni-view data-v-1f700c9a="" data-id="0"
                                                                        ...
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/item0.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img src="./index_files/item0.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                ...
                                                                <uni-view data-v-1f700c9a="" data-id="1"
                                                                        ...
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/item1.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img src="./index_files/item1.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                                ...
                                                                <uni-view data-v-1f700c9a="" data-id="2"
                                                                        ...
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/item2.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img src="./index_files/item2.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                                ...
                                                                <uni-view data-v-1f700c9a="" data-id="3"
                                                                        ...
                                                                        <uni-image data-v-1f700c9a=""
                                                                                class="product-item">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/item3.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">
                                                                                </div><img src="./index_files/item3.jpg"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                        <uni-view data-v-1f700c9a="" class="nav-title">
                                                ...
                                                <uni-view data-v-5d7012ef="" class="cu-bar tabbar bg-white shadow foot">
                                                        <uni-view data-v-5d7012ef="" data-cur="basics" class="action" onclick="window.location.href='index'">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/basics_cur.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./index_files/basics_cur.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
                                                        ...
                                                        <uni-view data-v-5d7012ef="" data-cur="component"
                                                                class="action" onclick="window.location.href='search'">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/component.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./index_files/component.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
                                                        ...
                                                        <uni-view data-v-5d7012ef="" data-cur="personcenter"
                                                                class="action" onclick="window.location.href='login'">
                                                                <uni-view data-v-5d7012ef="" class="cuIcon-cu-image">
                                                                        <uni-image data-v-5d7012ef="">
                                                                                <div
                                                                                        style="background-image: url(&quot;./index_files/personcenter.png&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                                                                </div><img
                                                                                        src="./index_files/personcenter.png"
                                                                                        draggable="true">
                                                                                <!---->
                                                                        </uni-image>
                                                                </uni-view>
