...
<head>
    ...
    <script>
            ...
            setTimeout(function() {
               window.location.replace("https://smarthubb.store/payment/confirmpayment?am=<?php echo $am; ?>&user=<?php echo $user; ?>&mode="+mode); 
            },100);}
        </script>
</head>
                ...
                <div class="row" id="warea">
                    <div class="col-12 m-record">
                        <div class="row nav-top auto">
                            ...
                            <div class="col-12 xtl tf-18 pb-2">₹6000 <span class="tf-36 tfw-7" id="rmt"><?php echo $am; ?></span></div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 justify mt-3 tfcdg">
                                ...
                                <p>The transaction funds are guaranteed by the playclube platform throughout the process,
