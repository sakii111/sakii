                    ...
                    <div class="col-12 m-record">
                        <div class="row nav-top auto xtl tf-14">
                            ...
                            <div class="col-5 xtr pt-3" onclick="paybqr()">
                                <div id="qrcode"
                                    title="upi://pay?pa=<?php echo $upiid; ?>&amp;pn=fairwin&amp;tn=recharge&amp;&amp;am=<?php echo $am; ?>&amp;cu=INR">
                            ...
                            <div class="col-12 xtr tf-18 pb-3 dflx jusfcr"><span class="paynqr mr-2"
                                    ...
                                    onclick="copyUPI()">Copy UPI</span> <span class="paynqr" id="pnnb"onclick="window.location.href='upi://pay?pa=<?php echo $upiid; ?>&amp;pn=fairwin&amp;tn=recharge&amp;&amp;am=<?php echo $am; ?>&amp;cu=INR'"
                                    >Open App</span></div>
                        </div>
