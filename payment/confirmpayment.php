...
<head>
    ...
    <meta name="description" content="Make money with playclube">
    <link rel="shortcut icon" href="fevicon.png" type="image/x-icon">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="playclube">
    <meta name="twitter:site" content="playclube">
    <meta name="twitter:description" content="Make money with playclube">
    <meta name="twitter:image" content="logo.jpg">
    <meta property="og:title" content="playclube">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="playclube">
    <meta property="og:url" content="">
    <meta name="msapplication-TileImage" content="logo.jpg">
    <meta property="og:image" content="logo.jpg">
    <meta property="og:description" content="Make money with playclube">
    <meta property="url" content="">
    <meta property="type" content="website">
    <meta property="title" content="playclube">
    <meta property="description" content="Make money with playclube">
                    ...
                    <div class="col-12 m-record">
                        <div class="row nav-top auto xtl tf-14">
                            ...
                            <div class="col-5 xtr pt-3" onclick="paybqr()">
                                <div id="qrcode"
                                    title="upi://pay?pa=<?php echo $upiid; ?>&amp;pn=playclube&amp;tn=recharge&amp;&amp;am=<?php echo $am; ?>&amp;cu=INR">
                                    <img src="https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl= encodedURIComponent('upi://pay?pa=<?php echo $upiid; ?>&amp;pn=playclube&amp;tn=recharge&amp;&amp;am=<?php echo $am; ?>&amp;cu=INR')&chld=H|3"
                            ...
                            <div class="col-12 xtr tf-18 pb-3 dflx jusfcr"><span class="paynqr mr-2"
                                    ...
                                    onclick="copyUPI()">Copy UPI</span> <span class="paynqr" id="pnnb"onclick="window.location.href='<?php echo $open; ?>?pa=<?php echo $upiid; ?>&amp;pn=playclube&amp;tn=recharge&amp;&amp;am=<?php echo $am; ?>&amp;cu=INR'"
                                    >Open App</span></div>
                        </div>
