...
Invite Bonus & Minimmum Recharge
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">Invite Bonus : 20 Rs</li>
    <li class="list-group-item">Minimmum Recharge: 200 Rs</li>
     <li class="list-group-item">Minimmum Withdrawal: 300 Rs</li>
