                        ...
                        <uni-view data-v-91f724d0="" data-v-5d7012ef="">
                            ...
                            <uni-view data-v-91f724d0="" class="padding-xl">
                                <uni-view data-v-91f724d0=""
                                    ...
                                    <uni-view data-v-91f724d0="" class="margin-top">
                                        <uni-text data-v-91f724d0=""><span>Available balance: ₹<span id="beconebalancetop">0.00</span></span></uni-text>
                                    </uni-view>
                                    <uni-button data-v-91f724d0=""
                                        class="my-textsize cu-btn bg-green shadow margin-top" onclick="location.href='recharge'" >Recharge</uni-button>
                                    <uni-button data-v-91f724d0=""
                                        class="my-textsize cu-btn bg-white shadow margin-left" id="readrule">Read Rule</uni-button>
                                    <uni-text data-v-91f724d0="" class="my-text cuIcon-refresh" onclick="location.reload()" ><span></span></uni-text>
                                </uni-view>
                            </uni-view>
                                        ...
                                        <div class="uni-scroll-view-content">
                                            ...
                                            <uni-view data-v-91f724d0="" class="flex text-center">
                                                <uni-view data-v-91f724d0="" data-id="0"
                                                    class="cu-item flex-sub my-textsize" onclick="window.location.href='win'">Parity</uni-view>
                                                <uni-view data-v-91f724d0="" data-id="1"
                                                    class="cu-item flex-sub my-textsize text-blue cur" onclick="window.location.href='win1'">Sapre</uni-view>
                                                <uni-view data-v-91f724d0="" data-id="2"
                                                    class="cu-item flex-sub my-textsize" onclick="window.location.href='win2'">Bcone</uni-view>
                                                <uni-view data-v-91f724d0="" data-id="3"
                                                    class="cu-item flex-sub my-textsize" onclick="window.location.href='win3'">Emerd</uni-view>
                                            </uni-view>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <uni-view data-v-91f724d0="" class="padding-xl">
                                ...
                                <uni-view data-v-91f724d0="" style="padding: 10px 10px 0px;">
                                    <uni-text data-v-91f724d0="" style="font-size: 1.5em;"><span id="period"><?php echo  $sperio?></span>
                                    </uni-text>
                                    <uni-text data-v-91f724d0="" class="my-lottery-time"><span id="demo"></span></uni-text>
                                </uni-view>
                            </uni-view>
                            <uni-view data-v-91f724d0="" class="flex padding justify-between">
                                <uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-green shadow"
                                    data-color="green" id="beconegreen"  onclick="green()">Join Green</uni-button>
                                <uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-purple shadow"
                                    data-color="violet" id="beconevoilet" onclick="vio()">Join Violet</uni-button>
                                <uni-button data-v-91f724d0="" class="my-textsize cu-btn bg-red shadow"
                                    data-color="red"  id="beconeredbutton" onclick="red()">Join Red</uni-button>
                            </uni-view>
                            <uni-view data-v-91f724d0="" class="grid margin-bottom text-center padding-xl">
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="0" id="beconenum0" onclick="beconenum0()"
                                    style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(229, 77, 66) 50%);">
                                    0</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="1" id="beconenum1" onclick="beconenum1()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    1</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="2" id="beconenum2" onclick="beconenum2()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    2</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="3" id="beconenum3" onclick="beconenum3()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    3</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="4" id="beconenum4" onclick="beconenum4()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    4</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="5" id="beconenum5" onclick="beconenum5()"
                                    style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(57, 181, 74) 50%);">
                                    5</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="6" id="beconenum6" onclick="beconenum6()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    6</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="7" id="beconenum7" onclick="beconenum7()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    7</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="8" id="beconenum8" onclick="beconenum8()"
                                    style="background-image: linear-gradient(160deg, rgb(229, 77, 66) 50%, rgb(229, 77, 66) 50%);">
                                    8</uni-button>
                                <uni-button data-v-91f724d0="" class="my-btn-num" data-num="9" id="beconenum9" onclick="beconenum9()"
                                    style="background-image: linear-gradient(160deg, rgb(57, 181, 74) 50%, rgb(57, 181, 74) 50%);">
                                    9</uni-button>
                            </uni-view>
                           
                            <div id="beconeansrec"> </div>
