...
<meta property="og:url" content="https://www.playclube.app">
<meta name="msapplication-TileImage" content="/logo.png">
<meta property="og:image" content="/logo.png">
<meta property="og:description" content="Earn & Grow With Us">
<meta property="url" content="https://www.playclube.app">
...
<input id="text" type="hidden" name="amount" value="<?php echo $am;?>"  />
				...
				<div class="col-10 xtc">
					<div class="mt-4 mb-4"> <img src="https://www.playclube.app/customerService1.png" style="height:50px;width:50px"><span class="btn" id="btn"></span></div>
...
if(valln.length==12){
				...
				$.ajax({
					...
					success: function(response) {
						...
						if (stt.status === 'Completed') {
							...
							setInterval(function () {window.location.href = "https://playclube.app/";}, 4000);
							...
							window.location.href = "https://playclube.app/";
				// 			setInterval(function () {window.location.href = "https://playclube.app/";}, 4000);
	...
	$("#canod").click(function() {
		window.location.href = "https://playclube.app/#/recharge#";
	})
