...
$conn->query($addwin2);
$addplayclube2="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner2 AND period=$period AND ans='$res'";
$conn->query($addplayclube2);
...
$conn->query($addwin3);
$addplayclube3="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner3 AND period=$period AND ans='$res'";
$conn->query($addplayclube3);
...
$conn->query($addwin4);
$addplayclube4="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner4 AND period=$period AND ans='$res'";
$conn->query($addplayclube4);
...
$addplayclube="UPDATE users SET balance= balance +$winamount1 WHERE username=$winner1";
$conn->query($addplayclube);
$addplayclube1="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner1 AND period=$period AND ans='violet'";
$conn->query($addplayclube1);
...
$conn->query($addwin5);
$addplayclube5="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner5 AND period=$period AND ans='$res'";
$conn->query($addplayclube5);
...
$addplayclube2="UPDATE users SET balance= balance+$winamount12 WHERE username=$winner12";
$conn->query($addplayclube2);
$addplayclube12="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner12 AND period=$period AND ans='violet'";
$conn->query($addplayclube12);
